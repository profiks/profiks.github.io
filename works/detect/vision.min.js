...
parts.join(COMPLEX_SELECTOR_SEP)},_transformDocumentSelector:function(selector){return this._transformComplexSelector(selector,SCOPE_DOC_SELECTOR)},_slottedToContent:function(cssText){return cssText.replace(SLOTTED_PAREN,CONTENT+"> $1")},_dirShadowTransform:function(selector){return selector.split(",").map(function(s){s=s.replace(HOST_DIR,HOST_DIR_REPLACE);s=s.replace(DIR_PAREN,SHADOW_DIR_REPLACE);return s}).join(",")},SCOPE_NAME:"style-scope"};var SCOPE_NAME=api.SCOPE_NAME;var SCOPE_DOC_SELECTOR=
...
'use strict';var g,n=n||{};n.scope={};n.ASSUME_ES5=!1;n.ASSUME_NO_NATIVE_MAP=!1;n.ASSUME_NO_NATIVE_SET=!1;n.defineProperty=n.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};n.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};n.global=n.getGlobal(this);n.SYMBOL_PREFIX="jscomp_symbol_";
n.initSymbol=function(){n.initSymbol=function(){};n.global.Symbol||(n.global.Symbol=n.Symbol)};n.Symbol=function(){function a(a){return n.SYMBOL_PREFIX+(a||"")+b++}var b=0;return a}();n.initSymbolIterator=function(){n.initSymbol();var a=n.global.Symbol.iterator;a||(a=n.global.Symbol.iterator=n.global.Symbol("iterator"));"function"!=typeof Array.prototype[a]&&n.defineProperty(Array.prototype,a,{configurable:!0,writable:!0,value:function(){return n.arrayIterator(this)}});n.initSymbolIterator=function(){}};
n.arrayIterator=function(a){var b=0;return n.iteratorPrototype(function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}})};n.iteratorPrototype=function(a){n.initSymbolIterator();a={next:a};a[n.global.Symbol.iterator]=function(){return this};return a};n.makeIterator=function(a){n.initSymbolIterator();var b=a[Symbol.iterator];return b?b.call(a):n.arrayIterator(a)};
n.iteratorFromArray=function(a,b){n.initSymbolIterator();a instanceof String&&(a+="");var c=0,d={next:function(){if(c<a.length){var e=c++;return{value:b(e,a[e]),done:!1}}d.next=function(){return{done:!0,value:void 0}};return d.next()}};d[Symbol.iterator]=function(){return d};return d};
n.polyfill=function(a,b){if(b){var c=n.global;a=a.split(".");for(var d=0;d<a.length-1;d++){var e=a[d];e in c||(c[e]={});c=c[e]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&n.defineProperty(c,a,{configurable:!0,writable:!0,value:b})}};n.polyfill("Array.prototype.keys",function(a){return a?a:a=function(){return n.iteratorFromArray(this,function(a){return a})}},"es6","es3");
n.polyfill("Array.prototype.fill",function(a){return a?a:a=function(a,c,d){var b=this.length||0;0>c&&(c=Math.max(0,b+c));if(null==d||d>b)d=b;d=Number(d);0>d&&(d=Math.max(0,b+d));for(c=Number(c||0);c<d;c++)this[c]=a;return this}},"es6","es3");
n.polyfill("Array.from",function(a){return a?a:a=function(a,c,d){n.initSymbolIterator();c=null!=c?c:function(a){return a};var b=[],f=a[Symbol.iterator];if("function"==typeof f)for(a=f.call(a);!(f=a.next()).done;)b.push(c.call(d,f.value));else{f=a.length;for(var l=0;l<f;l++)b.push(c.call(d,a[l]))}return b}},"es6","es3");n.polyfill("Math.sign",function(a){return a?a:a=function(a){a=Number(a);return 0===a||isNaN(a)?a:0<a?1:-1}},"es6","es3");n.FORCE_POLYFILL_PROMISE=!1;
n.polyfill("Promise",function(a){function b(){this.batch_=null}function c(a){return a instanceof f?a:new f(function(b){b(a)})}if(a&&!n.FORCE_POLYFILL_PROMISE)return a;b.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};b.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var d=n.global.setTimeout;b.prototype.asyncExecuteFunction=function(a){d(a,0)};b.prototype.executeBatch_=
function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var b=0;b<a.length;++b){var d=a[b];delete a[b];try{d()}catch(r){this.asyncThrow_(r)}}}this.batch_=null};b.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var e={PENDING:0,FULFILLED:1,REJECTED:2},f=function(a){this.state_=e.PENDING;this.result_=void 0;this.onSettledCallbacks_=[];var b=this.createResolveAndReject_();try{a(b.resolve,b.reject)}catch(m){b.reject(m)}};f.prototype.createResolveAndReject_=
...
void 0;try{b=a.then}catch(m){this.reject_(m);return}"function"==typeof b?this.settleSameAsThenable_(b,a):this.fulfill_(a)};f.prototype.reject_=function(a){this.settle_(e.REJECTED,a)};f.prototype.fulfill_=function(a){this.settle_(e.FULFILLED,a)};f.prototype.settle_=function(a,b){if(this.state_!=e.PENDING)throw Error("Cannot settle("+a+", "+b|"): Promise already settled in state"+this.state_);this.state_=a;this.result_=b;this.executeOnSettledCallbacks_()};f.prototype.executeOnSettledCallbacks_=function(){if(null!=
this.onSettledCallbacks_){for(var a=this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var l=new b;f.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};f.prototype.settleSameAsThenable_=function(a,b){var d=this.createResolveAndReject_();try{a.call(b,d.resolve,d.reject)}catch(r){d.reject(r)}};f.prototype.then=function(a,b){function d(a,b){return"function"==typeof a?function(b){try{c(a(b))}catch(u){e(u)}}:
b}var c,e,h=new f(function(a,b){c=a;e=b});this.callWhenSettled_(d(a,c),d(b,e));return h};f.prototype.catch=function(a){return this.then(void 0,a)};f.prototype.callWhenSettled_=function(a,b){function d(){switch(c.state_){case e.FULFILLED:a(c.result_);break;case e.REJECTED:b(c.result_);break;default:throw Error("Unexpected state: "+c.state_);}}var c=this;null==this.onSettledCallbacks_?l.asyncExecute(d):this.onSettledCallbacks_.push(function(){l.asyncExecute(d)})};f.resolve=c;f.reject=function(a){return new f(function(b,
d){d(a)})};f.race=function(a){return new f(function(b,d){for(var e=n.makeIterator(a),f=e.next();!f.done;f=e.next())c(f.value).callWhenSettled_(b,d)})};f.all=function(a){var b=n.makeIterator(a),d=b.next();return d.done?c([]):new f(function(a,e){function f(b){return function(d){h[b]=d;k--;0==k&&a(h)}}var h=[],k=0;do h.push(void 0),k++,c(d.value).callWhenSettled_(f(h.length-1),e),d=b.next();while(!d.done)})};return f},"es6","es3");var p=p||{};p.global=this;p.isDef=function(a){return void 0!==a};
p.isString=function(a){return"string"==typeof a};p.isBoolean=function(a){return"boolean"==typeof a};p.isNumber=function(a){return"number"==typeof a};p.exportPath_=function(a,b,c){a=a.split(".");c=c||p.global;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&p.isDef(b)?c[d]=b:c=c[d]&&c[d]!==Object.prototype[d]?c[d]:c[d]={}};p.define=function(a,b){p.exportPath_(a,b)};p.DEBUG=!0;p.LOCALE="en";p.TRUSTED_SITE=!0;p.STRICT_MODE_COMPATIBLE=!1;
p.DISALLOW_TEST_ONLY_CODE=!p.DEBUG;p.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;p.provide=function(a){if(p.isInModuleLoader_())throw Error("goog.provide can not be used within a goog.module.");p.constructNamespace_(a)};p.constructNamespace_=function(a,b){p.exportPath_(a,b)};p.VALID_MODULE_RE_=/^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
p.module=function(a){if(!p.isString(a)||!a||-1==a.search(p.VALID_MODULE_RE_))throw Error("Invalid module identifier");if(!p.isInModuleLoader_())throw Error("Module "+a+" has been loaded incorrectly. Note, modules cannot be loaded as normal scripts. They require some kind of pre-processing step. You're likely trying to load a module via a script tag or as a part of a concatenated bundle without rewriting the module. For more info see: https://github.com/google/closure-library/wiki/goog.module:-an-ES6-module-like-alternative-to-goog.provide.");if(p.moduleLoaderState_.moduleName)throw Error("goog.module may only be called once per module.");
p.moduleLoaderState_.moduleName=a};p.module.get=function(){return null};p.module.getInternal_=function(){return null};p.moduleLoaderState_=null;p.isInModuleLoader_=function(){return null!=p.moduleLoaderState_};p.module.declareLegacyNamespace=function(){p.moduleLoaderState_.declareLegacyNamespace=!0};p.setTestOnly=function(a){if(p.DISALLOW_TEST_ONLY_CODE)throw a=a||"",Error("Importing test-only code into non-debug environment"+(a?": "+a:"."));};p.forwardDeclare=function(){};
p.getObjectByName=function(a,b){a=a.split(".");b=b||p.global;for(var c=0;c<a.length;c++)if(b=b[a[c]],!p.isDefAndNotNull(b))return null;return b};p.globalize=function(a,b){b=b||p.global;for(var c in a)b[c]=a[c]};p.addDependency=function(a,b,c,d){if(p.DEPENDENCIES_ENABLED){var e=p.getLoader_();e&&e.addDependency(a,b,c,d)}};p.useStrictRequires=!1;p.ENABLE_DEBUG_LOADER=!0;p.logToConsole_=function(a){p.global.console&&p.global.console.error(a)};
p.require=function(a){p.ENABLE_DEBUG_LOADER&&p.debugLoader_&&p.getLoader_().earlyProcessLoad(a)};p.basePath="";p.nullFunction=function(){};p.abstractMethod=function(){throw Error("unimplemented abstract method");};p.addSingletonGetter=function(a){a.instance_=void 0;a.getInstance=function(){if(a.instance_)return a.instance_;p.DEBUG&&(p.instantiatedSingletons_[p.instantiatedSingletons_.length]=a);return a.instance_=new a}};p.instantiatedSingletons_=[];p.LOAD_MODULE_USING_EVAL=!0;
p.SEAL_MODULE_EXPORTS=p.DEBUG;p.loadedModules_={};p.DEPENDENCIES_ENABLED=!1;p.TRANSPILE="detect";p.TRANSPILER="transpile.js";p.DEBUG_LOADER="";p.hasBadLetScoping=null;p.useSafari10Workaround=function(){if(null==p.hasBadLetScoping){try{var a=!eval('"use strict";let x = 1; function f() { return typeof x; };f() == "number";')}catch(b){a=!1}p.hasBadLetScoping=a}return p.hasBadLetScoping};p.workaroundSafari10EvalBug=function(a){return"(function(){"+a+"\n;})();\n"};
p.loadModule=function(a){var b=p.moduleLoaderState_;try{p.moduleLoaderState_={moduleName:void 0,declareLegacyNamespace:!1};if(p.isFunction(a))var c=a.call(void 0,{});else if(p.isString(a))p.useSafari10Workaround()&&(a=p.workaroundSafari10EvalBug(a)),c=p.loadModuleFromSource_.call(void 0,a);else throw Error("Invalid module definition");var d=p.moduleLoaderState_.moduleName;if(!p.isString(d)||!d)throw Error('Invalid module name "'+d+'"');p.moduleLoaderState_.declareLegacyNamespace?p.constructNamespace_(d,
c):p.SEAL_MODULE_EXPORTS&&Object.seal&&"object"==typeof c&&null!=c&&Object.seal(c);p.loadedModules_[d]=c}finally{p.moduleLoaderState_=b}};p.loadModuleFromSource_=function(a){var b={};eval(a);return b};p.normalizePath_=function(a){a=a.split("/");for(var b=0;b<a.length;)"."==a[b]?a.splice(b,1):b&&".."==a[b]&&a[b-1]&&".."!=a[b-1]?a.splice(--b,2):b++;return a.join("/")};
p.loadFileSync_=function(a){if(p.global.CLOSURE_LOAD_FILE_SYNC)return p.global.CLOSURE_LOAD_FILE_SYNC(a);try{var b=new p.global.XMLHttpRequest;b.open("get",a,!1);b.send();return 0==b.status||200==b.status?b.responseText:null}catch(c){return null}};
p.transpile_=function(a,b){var c=p.global.$jscomp;c||(p.global.$jscomp=c={});var d=c.transpile;if(!d){var e=p.basePath+p.TRANSPILER,f=p.loadFileSync_(e);if(f){(function(){eval(f+"\n//# sourceURL="+e)}).call(p.global);if(p.global.$gwtExport&&p.global.$gwtExport.$jscomp&&!p.global.$gwtExport.$jscomp.transpile)throw Error('The transpiler did not properly export the "transpile" method. $gwtExport: '+JSON.stringify(p.global.$gwtExport));p.global.$jscomp.transpile=p.global.$gwtExport.$jscomp.transpile;
c=p.global.$jscomp;d=c.transpile}}if(!d){var l=" requires transpilation but no transpiler was found.";l+=' Please add "//javascript/closure:transpiler" as a data dependency to ensure it is included.';d=c.transpile=function(a,b){p.logToConsole_(b+l);return a}}return d(a,b)};
p.typeOf=function(a){var b=typeof a;if("object"==b)if(a){if(a instanceof Array)return"array";if(a instanceof Object)return b;var c=Object.prototype.toString.call(a);if("[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a.length&&"undefined"!=typeof a.splice&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("splice"))return"array";if("[object Function]"==c||"undefined"!=typeof a.call&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("call"))return"function"}else return"null";
else if("function"==b&&"undefined"==typeof a.call)return"object";return b};p.isNull=function(a){return null===a};p.isDefAndNotNull=function(a){return null!=a};p.isArray=function(a){return"array"==p.typeOf(a)};p.isArrayLike=function(a){var b=p.typeOf(a);return"array"==b||"object"==b&&"number"==typeof a.length};p.isDateLike=function(a){return p.isObject(a)&&"function"==typeof a.getFullYear};p.isFunction=function(a){return"function"==p.typeOf(a)};
p.isObject=function(a){var b=typeof a;return"object"==b&&null!=a||"function"==b};p.getUid=function(a){return a[p.UID_PROPERTY_]||(a[p.UID_PROPERTY_]=++p.uidCounter_)};p.hasUid=function(a){return!!a[p.UID_PROPERTY_]};p.removeUid=function(a){null!==a&&"removeAttribute"in a&&a.removeAttribute(p.UID_PROPERTY_);try{delete a[p.UID_PROPERTY_]}catch(b){}};p.UID_PROPERTY_="closure_uid_"+(1E9*Math.random()>>>0);p.uidCounter_=0;p.getHashCode=p.getUid;p.removeHashCode=p.removeUid;
p.cloneObject=function(a){var b=p.typeOf(a);if("object"==b||"array"==b){if(a.clone)return a.clone();b="array"==b?[]:{};for(var c in a)b[c]=p.cloneObject(a[c]);return b}return a};p.bindNative_=function(a,b,c){return a.call.apply(a.bind,arguments)};
p.bindJs_=function(a,b,c){if(!a)throw Error();if(2<arguments.length){var d=Array.prototype.slice.call(arguments,2);return function(){var c=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(c,d);return a.apply(b,c)}}return function(){return a.apply(b,arguments)}};p.bind=function(a,b,c){p.bind=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?p.bindNative_:p.bindJs_;return p.bind.apply(null,arguments)};
p.partial=function(a,b){var c=Array.prototype.slice.call(arguments,1);return function(){var b=c.slice();b.push.apply(b,arguments);return a.apply(this,b)}};p.mixin=function(a,b){for(var c in b)a[c]=b[c]};p.now=p.TRUSTED_SITE&&Date.now||function(){return+new Date};
p.globalEval=function(a){if(p.global.execScript)p.global.execScript(a,"JavaScript");else if(p.global.eval){if(null==p.evalWorksForGlobals_){try{p.global.eval("var _evalTest_ = 1;")}catch(d){}if("undefined"!=typeof p.global._evalTest_){try{delete p.global._evalTest_}catch(d){}p.evalWorksForGlobals_=!0}else p.evalWorksForGlobals_=!1}if(p.evalWorksForGlobals_)p.global.eval(a);else{var b=p.global.document,c=b.createElement("SCRIPT");c.type="text/javascript";c.defer=!1;c.appendChild(b.createTextNode(a));
b.head.appendChild(c);b.head.removeChild(c)}}else throw Error("goog.globalEval not available");};p.evalWorksForGlobals_=null;
p.getCssName=function(a,b){if("."==String(a).charAt(0))throw Error('className passed in goog.getCssName must not start with ".". You passed: '+a);var c=function(a){return p.cssNameMapping_[a]||a},d=function(a){a=a.split("-");for(var b=[],d=0;d<a.length;d++)b.push(c(a[d]));return b.join("-")};d=p.cssNameMapping_?"BY_WHOLE"==p.cssNameMappingStyle_?c:d:function(a){return a};a=b?a+"-"+d(b):d(a);return p.global.CLOSURE_CSS_NAME_MAP_FN?p.global.CLOSURE_CSS_NAME_MAP_FN(a):a};
p.setCssNameMapping=function(a,b){p.cssNameMapping_=a;p.cssNameMappingStyle_=b};p.getMsg=function(a,b){b&&(a=a.replace(/\{\$([^}]+)}/g,function(a,d){return null!=b&&d in b?b[d]:a}));return a};p.getMsgWithFallback=function(a){return a};p.exportSymbol=function(a,b,c){p.exportPath_(a,b,c)};p.exportProperty=function(a,b,c){a[b]=c};
p.inherits=function(a,b){function c(){}c.prototype=b.prototype;a.superClass_=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.base=function(a,c,f){for(var d=Array(arguments.length-2),e=2;e<arguments.length;e++)d[e-2]=arguments[e];return b.prototype[c].apply(a,d)}};
p.base=function(a,b,c){var d=arguments.callee.caller;if(p.STRICT_MODE_COMPATIBLE||p.DEBUG&&!d)throw Error("arguments.caller not defined.  goog.base() cannot be used with strict mode code. See http://www.ecma-international.org/ecma-262/5.1/#sec-C");if(d.superClass_){for(var e=Array(arguments.length-1),f=1;f<arguments.length;f++)e[f-1]=arguments[f];return d.superClass_.constructor.apply(a,e)}e=Array(arguments.length-2);for(f=2;f<arguments.length;f++)e[f-2]=arguments[f];f=!1;for(var l=a.constructor;l;l=
l.superClass_&&l.superClass_.constructor)if(l.prototype[b]===d)f=!0;else if(f)return l.prototype[b].apply(a,e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};p.scope=function(a){if(p.isInModuleLoader_())throw Error("goog.scope is not supported within a goog.module.");a.call(p.global)};
p.defineClass=function(a,b){var c=b.constructor,d=b.statics;c&&c!=Object.prototype.constructor||(c=function(){throw Error("cannot instantiate an interface (no constructor defined).");});c=p.defineClass.createSealingConstructor_(c,a);a&&p.inherits(c,a);delete b.constructor;delete b.statics;p.defineClass.applyProperties_(c.prototype,b);null!=d&&(d instanceof Function?d(c):p.defineClass.applyProperties_(c,d));return c};p.defineClass.SEAL_CLASS_INSTANCES=p.DEBUG;
p.defineClass.createSealingConstructor_=function(a,b){if(!p.defineClass.SEAL_CLASS_INSTANCES)return a;var c=!p.defineClass.isUnsealable_(b),d=function(){var b=a.apply(this,arguments)||this;b[p.UID_PROPERTY_]=b[p.UID_PROPERTY_];this.constructor===d&&c&&Object.seal instanceof Function&&Object.seal(b);return b};return d};p.defineClass.isUnsealable_=function(a){return a&&a.prototype&&a.prototype[p.UNSEALABLE_CONSTRUCTOR_PROPERTY_]};p.defineClass.OBJECT_PROTOTYPE_FIELDS_="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");
p.defineClass.applyProperties_=function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c]);for(var d=0;d<p.defineClass.OBJECT_PROTOTYPE_FIELDS_.length;d++)c=p.defineClass.OBJECT_PROTOTYPE_FIELDS_[d],Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c])};p.tagUnsealableClass=function(){};p.UNSEALABLE_CONSTRUCTOR_PROPERTY_="goog_defineClass_legacy_unsealable";
if(p.DEPENDENCIES_ENABLED){p.inHtmlDocument_=function(){var a=p.global.document;return null!=a&&"write"in a};p.findBasePath_=function(){if(p.isDef(p.global.CLOSURE_BASE_PATH)&&p.isString(p.global.CLOSURE_BASE_PATH))p.basePath=p.global.CLOSURE_BASE_PATH;else if(p.inHtmlDocument_()){var a=p.global.document,b=a.currentScript;a=b?[b]:a.getElementsByTagName("SCRIPT");for(b=a.length-1;0<=b;--b){var c=a[b];c=c.src;var d=c.lastIndexOf("?");d=-1==d?c.length:d;if("base.js"==c.substr(d-7,7)){p.basePath=c.substr(0,
d-7);break}}}};p.findBasePath_();p.Transpiler=function(){this.requiresTranspilation_=null};p.Transpiler.prototype.createRequiresTranspilation_=function(){function a(a,b){d?c[a]=!0:b()?c[a]=!1:d=c[a]=!0}function b(a){try{return!!eval(a)}catch(l){return!1}}var c={es3:!1},d=!1,e=p.global.navigator&&p.global.navigator.userAgent?p.global.navigator.userAgent:"";a("es5",function(){return b("[1,].length==1")});a("es6",function(){var a=/Edge\/(\d+)(\.\d)*/i;return(a=e.match(a))&&15>Number(a[1])?!1:b('(()=>{"use strict";class X{constructor(){if(new.target!=String)throw 1;this.x=42}}let q=Reflect.construct(X,[],String);if(q.x!=42||!(q instanceof String))throw 1;for(const a of[2,3]){if(a==2)continue;function f(z={a}){let a=0;return z.a}{function f(){return 0;}}return f()==3}})()')});
a("es6-impl",function(){return!0});a("es7",function(){return b("2 ** 2 == 4")});a("es8",function(){return b("async () => 1, true")});return c};p.Transpiler.prototype.needsTranspile=function(a){if("always"==p.TRANSPILE)return!0;if("never"==p.TRANSPILE)return!1;this.requiresTranspilation_||(this.requiresTranspilation_=this.createRequiresTranspilation_());if(a in this.requiresTranspilation_)return this.requiresTranspilation_[a];throw Error("Unknown language mode: "+a);};p.Transpiler.prototype.transpile=
function(a,b){return p.transpile_(a,b)};p.transpiler_=new p.Transpiler;p.DebugLoader=function(){this.dependencies_={loadFlags:{},nameToPath:{},requires:{},visited:{},written:{},deferred:{}};this.lastNonModuleScriptIndex_=0};p.DebugLoader.IS_OLD_IE_=!(p.global.atob||!p.global.document||!p.global.document.all);g=p.DebugLoader.prototype;g.earlyProcessLoad=function(a){p.DebugLoader.IS_OLD_IE_&&this.maybeProcessDeferredDep_(a)};g.load=function(a){var b=this.getPathFromDeps_(a);if(b){var c=function(a){if(!(a in
f.written||a in f.visited)){f.visited[a]=!0;if(a in f.requires)for(var b in f.requires[a])if(!l.isProvided(b))if(b in f.nameToPath)c(f.nameToPath[b]);else throw Error("Undefined nameToPath for "+b);a in e||(e[a]=!0,d.push(a))}},d=[],e={},f=this.dependencies_,l=this;c(b);for(a=0;a<d.length;a++)b=d[a],this.dependencies_.written[b]=!0;for(a=0;a<d.length;a++)if(b=d[a]){var h=f.loadFlags[b]||{},k=h.lang||"es3";k=this.getTranspiler().needsTranspile(k);"goog"==h.module||k?this.importProcessedScript_(p.basePath+
b,"goog"==h.module,k):this.importScript_(p.basePath+b)}else throw Error("Undefined script input");}else if(a="goog.require could not find: "+a,this.logToConsole(a),p.useStrictRequires)throw Error(a);};g.addDependency=function(a,b,c,d){var e;a=a.replace(/\\/g,"/");var f=this.dependencies_;d&&"boolean"!==typeof d||(d=d?{module:"goog"}:{});for(var l=0;e=b[l];l++)f.nameToPath[e]=a,f.loadFlags[a]=d;for(d=0;b=c[d];d++)a in f.requires||(f.requires[a]={}),f.requires[a][b]=!0};g.importScript_=function(a,b){var c=
p.global.CLOSURE_IMPORT_SCRIPT||p.bind(this.writeScriptTag_,this);c(a,b)&&(this.dependencies_.written[a]=!0)};g.importProcessedScript_=function(a,b,c){a='goog.debugLoader_.retrieveAndExec_("'+a+'", '+b+", "+c+");";this.importScript_("",a)};g.maybeProcessDeferredDep_=function(a){this.isDeferredModule_(a)&&this.allDepsAreAvailable_(a)&&(a=this.getPathFromDeps_(a),this.maybeProcessDeferredPath_(p.basePath+a))};g.isDeferredModule_=function(a){var b=(a=this.getPathFromDeps_(a))&&this.dependencies_.loadFlags[a]||
{},c=b.lang||"es3";return a&&("goog"==b.module||this.getTranspiler().needsTranspile(c))?(a=p.basePath+a,a in this.dependencies_.deferred):!1};g.allDepsAreAvailable_=function(a){if((a=this.getPathFromDeps_(a))&&a in this.dependencies_.requires)for(var b in this.dependencies_.requires[a])if(!this.isProvided(b)&&!this.isDeferredModule_(b))return!1;return!0};g.maybeProcessDeferredPath_=function(a){if(a in this.dependencies_.deferred){var b=this.dependencies_.deferred[a];delete this.dependencies_.deferred[a];
p.globalEval(b)}};g.writeScriptSrcNode_=function(a){p.global.document.write('<script type="text/javascript" src="'+a+'">\x3c/script>')};g.appendScriptSrcNode_=function(a){var b=p.global.document,c=b.createElement("script");c.type="text/javascript";c.src=a;c.defer=!1;c.async=!1;b.head.appendChild(c)};g.writeScriptTag_=function(a,b){if(this.inHtmlDocument()){var c=p.global.document;if(!p.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING&&"complete"==c.readyState){if(c=/\bdeps.js$/.test(a))return!1;throw Error('Cannot write "'+
a+'" after document load');}void 0===b?p.DebugLoader.IS_OLD_IE_?(b=" onreadystatechange='goog.debugLoader_.onScriptLoad_(this, "+ ++this.lastNonModuleScriptIndex_+")' ",c.write('<script type="text/javascript" src="'+a+'"'+b+">\x3c/script>")):p.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING?this.appendScriptSrcNode_(a):this.writeScriptSrcNode_(a):c.write('<script type="text/javascript">'+this.protectScriptTag_(b)+"\x3c/script>");return!0}return!1};g.protectScriptTag_=function(a){return a.replace(/<\/(SCRIPT)/ig,
"\\x3c/$1")};g.getPathFromDeps_=function(a){return a in this.dependencies_.nameToPath?this.dependencies_.nameToPath[a]:null};g.getTranspiler=function(){return p.transpiler_};g.isProvided=function(a){return p.isProvided_(a)};g.inHtmlDocument=function(){return p.inHtmlDocument_()};g.logToConsole=function(a){p.logToConsole_(a)};p.debugLoader_=null;p.registerDebugLoader=function(a){if(p.debugLoader_)throw Error("Debug loader already registered!");if(!(a instanceof p.DebugLoader))throw Error("Not a goog.DebugLoader.");
p.debugLoader_=a};p.getLoader_=function(){if(!p.debugLoader_&&p.DEBUG_LOADER)throw Error("Loaded debug loader file but no loader was registered!");p.debugLoader_||(p.debugLoader_=new p.DebugLoader);return p.debugLoader_};var x;p.DEBUG_LOADER&&(x=new p.DebugLoader,x.importScript_(p.basePath+p.DEBUG_LOADER));p.global.CLOSURE_NO_DEPS||(x=x||new p.DebugLoader,p.DEBUG_LOADER||p.registerDebugLoader(x),x.importScript_(p.basePath+"deps.js"))};var D={IronResizableBehavior:{}};D.IronResizableBehavior.IronResizableBehavior={};
...
this._boundNotifyResize);this._parentResizable=null},notifyResize:function(){this.isAttached&&(this._interestedResizables.forEach(function(a){this._notifyDescendant(a)},this),this._fireResize())},assignParentResizable:function(a){this._parentResizable=a},stopResizeNotificationsFor:function(a){var b=this._interestedResizables.indexOf(a);-1<b&&(this._interestedResizables.splice(b,1),this.unlisten(a,"iron-resize","_onDescendantIronResize"))},resizerShouldNotify:function(){return!0},_onDescendantIronResize:function(a){this._notifyingDescendant?
a.stopPropagation():Polymer.Settings.useShadow||this._fireResize()},_fireResize:function(){this.fire("iron-resize",null,{node:this,bubbles:!1})},_onIronRequestResizeNotifications:function(a){var b=Polymer.dom(a).rootTarget;b!==this&&(-1===this._interestedResizables.indexOf(b)&&(this._interestedResizables.push(b),this.listen(b,"iron-resize","_onDescendantIronResize")),b.assignParentResizable(this),this._notifyDescendant(b),a.stopPropagation())},_parentResizableChanged:function(a){a&&window.removeEventListener("resize",
this._boundNotifyResize)},_notifyDescendant:function(a){this.isAttached&&(this._notifyingDescendant=!0,a.notifyResize(),this._notifyingDescendant=!1)},_requestResizeNotifications:function(){if(this.isAttached)if("loading"===document.readyState){var a=this._requestResizeNotifications.bind(this);document.addEventListener("readystatechange",function c(){document.removeEventListener("readystatechange",c);a()})}else this.fire("iron-request-resize-notifications",null,{node:this,bubbles:!0,cancelable:!0}),
this._parentResizable||(window.addEventListener("resize",this._boundNotifyResize),this.notifyResize())}};D.IronSelector={};D.IronSelector.IronSelection={};Polymer.IronSelection=function(a){this.selection=[];this.selectCallback=a};
...
this.toggle(a):this.get()!==a&&(this.setItemSelected(this.get(),!1),this.setItemSelected(a,!0))},toggle:function(a){this.setItemSelected(a,!this.isSelected(a))}};D.IronSelector.IronSelectable={};
...
_valueToItem:function(a){return null==a?null:this.items[this._valueToIndex(a)]},_valueToIndex:function(a){if(this.attrForSelected)for(var b=0,c;c=this.items[b];b++){if(this._valueForItem(c)==a)return b}else return Number(a)},_indexToValue:function(a){if(this.attrForSelected){if(a=this.items[a])return this._valueForItem(a)}else return a},_valueForItem:function(a){if(!a)return null;var b=a[Polymer.CaseMap.dashToCamelCase(this.attrForSelected)];return void 0!=b?b:a.getAttribute(this.attrForSelected)},
_applySelection:function(a,b){this.selectedClass&&this.toggleClass(this.selectedClass,b,a);this.selectedAttribute&&this.toggleAttribute(this.selectedAttribute,b,a);this._selectionChange();this.fire("iron-"+(b?"select":"deselect"),{item:a})},_selectionChange:function(){this._setSelectedItem(this._selection.get())},_observeItems:function(a){return Polymer.dom(a).observeNodes(function(a){this._updateItems();this._updateSelected();this.fire("iron-items-changed",a,{bubbles:!1,cancelable:!1})})},_activateHandler:function(a){a=
a.target;for(var b=this.items;a&&a!=this;){var c=b.indexOf(a);if(0<=c){b=this._indexToValue(c);this._itemActivate(b,a);break}a=a.parentNode}},_itemActivate:function(a,b){this.fire("iron-activate",{selected:a,item:b},{cancelable:!0}).defaultPrevented||this.select(a)}};D.IronPages={};D.IronPages.IronPages={};Polymer({is:"iron-pages",behaviors:[Polymer.IronResizableBehavior,Polymer.IronSelectableBehavior],properties:{activateEvent:{type:String,value:null}},observers:["_selectedPageChanged(selected)"],_selectedPageChanged:function(){this.async(this.notifyResize)}});D.IronFlexLayout={};D.IronFlexLayout.IronFlexLayout={};D.IronImage={};D.IronImage.IronImage={};
...
_transformChanged:function(){var a=this.$.sizedImgDiv.style,b=this.$.placeholder.style;a.backgroundSize=b.backgroundSize=this.sizing;a.backgroundPosition=b.backgroundPosition=this.sizing?this.position:"";a.backgroundRepeat=b.backgroundRepeat=this.sizing?"no-repeat":""},_resolveSrc:function(a){var b=this.ownerDocument.baseURI;return b?(new URL(a,b)).href:a}});D.PaperStyles={};D.PaperStyles.Color={};D.PaperStyles.DefaultTheme={};D.PaperStyles.Shadow={};D.PaperMaterial={};D.PaperMaterial.PaperMaterialSharedStyles={};D.PaperMaterial.PaperMaterial={};Polymer({is:"paper-material",properties:{elevation:{type:Number,reflectToAttribute:!0,value:1},animated:{type:Boolean,reflectToAttribute:!0,value:!1}}});D.PaperCard={};D.PaperCard.PaperCard={};
Polymer({is:"paper-card",properties:{heading:{type:String,value:"",observer:"_headingChanged"},image:{type:String,value:""},alt:{type:String},preloadImage:{type:Boolean,value:!1},fadeImage:{type:Boolean,value:!1},placeholderImage:{type:String,value:null},elevation:{type:Number,value:1,reflectToAttribute:!0},animatedShadow:{type:Boolean,value:!1},animated:{type:Boolean,reflectToAttribute:!0,readOnly:!0,computed:"_computeAnimated(animatedShadow)"}},_isHidden:function(a){return a?"false":"true"},_headingChanged:function(a){this.getAttribute("aria-label");
this.setAttribute("aria-label",a)},_computeHeadingClass:function(a){return a?" over-image":""},_computeAnimated:function(a){return a}});D.IronA11yKeysBehavior={};D.IronA11yKeysBehavior.IronA11yKeysBehavior={};
(function(){function a(a,b){var d="";if(a)if(a=a.toLowerCase()," "===a||r.test(a))d="space";else if(t.test(a))d="esc";else if(1==a.length){if(!b||h.test(a))d=a}else d=m.test(a)?a.replace("arrow",""):"multiply"==a?"*":a;return d}function b(b,d){var c=d;var h=b.hasModifiers;if(c.key)c=a(c.key,h);else if(c.detail&&c.detail.key)c=a(c.detail.key,h);else{h=c.keyIdentifier;var m="";h&&(h in e?m=e[h]:k.test(h)?(h=parseInt(h.replace("U+","0x"),16),m=String.fromCharCode(h).toLowerCase()):m=h.toLowerCase());
h=m;h||(c=c.keyCode,h="",Number(c)&&(h=65<=c&&90>=c?String.fromCharCode(32+c):112<=c&&123>=c?"f"+(c-112):48<=c&&57>=c?String(c-48):96<=c&&105>=c?String(c-96):f[c]));c=h||""}return c===b.key&&(!b.hasModifiers||!!d.shiftKey===!!b.shiftKey&&!!d.ctrlKey===!!b.ctrlKey&&!!d.altKey===!!b.altKey&&!!d.metaKey===!!b.metaKey)}function c(a){return 1===a.length?{combo:a,key:a,event:"keydown"}:a.split("+").reduce(function(a,b){var d=b.split(":");b=d[0];d=d[1];b in l?(a[l[b]]=!0,a.hasModifiers=!0):(a.key=b,a.event=
d||"keydown");return a},{combo:a.split(":").shift()})}function d(a){return a.trim().split(" ").map(function(a){return c(a)})}var e={"U+0008":"backspace","U+0009":"tab","U+001B":"esc","U+0020":"space","U+007F":"del"},f={8:"backspace",9:"tab",13:"enter",27:"esc",33:"pageup",34:"pagedown",35:"end",36:"home",32:"space",37:"left",38:"up",39:"right",40:"down",46:"del",106:"*"},l={shift:"shiftKey",ctrl:"ctrlKey",alt:"altKey",meta:"metaKey"},h=/[a-z0-9*]/,k=/U\+/,m=/^arrow/,r=/^space(bar)?/,t=/^escape$/;
...
_prepKeyBindings:function(){this._keyBindings={};this._collectKeyBindings().forEach(function(a){for(var b in a)this._addKeyBinding(b,a[b])},this);for(var a in this._imperativeKeyBindings)this._addKeyBinding(a,this._imperativeKeyBindings[a]);for(var b in this._keyBindings)this._keyBindings[b].sort(function(a,b){a=a[0].hasModifiers;b=b[0].hasModifiers;return a===b?0:a?-1:1})},_addKeyBinding:function(a,b){d(a).forEach(function(a){this._keyBindings[a.event]=this._keyBindings[a.event]||[];this._keyBindings[a.event].push([a,
b])},this)},_resetKeyEventListeners:function(){this._unlistenKeyEventListeners();this.isAttached&&this._listenKeyEventListeners()},_listenKeyEventListeners:function(){this.keyEventTarget&&Object.keys(this._keyBindings).forEach(function(a){var b=this._keyBindings[a];b=this._onKeyBindingEvent.bind(this,b);this._boundKeyHandlers.push([this.keyEventTarget,a,b]);this.keyEventTarget.addEventListener(a,b)},this)},_unlistenKeyEventListeners:function(){for(var a,b,d;this._boundKeyHandlers.length;)a=this._boundKeyHandlers.pop(),
b=a[0],d=a[1],a=a[2],b.removeEventListener(d,a)},_onKeyBindingEvent:function(a,d){this.stopKeyboardEventPropagation&&d.stopPropagation();if(!d.defaultPrevented)for(var c=0;c<a.length;c++){var e=a[c][0],h=a[c][1];if(b(e,d)&&(this._triggerKeyHandler(e,h,d),d.defaultPrevented))break}},_triggerKeyHandler:function(a,b,d){var c=Object.create(a);c.keyboardEvent=d;a=new CustomEvent(a.event,{detail:c,cancelable:!0});this[b].call(this,a);a.defaultPrevented&&d.preventDefault()}}})();D.IronBehaviors={};D.IronBehaviors.IronControlState={};
...
this.style.pointerEvents=a?"none":"";a?(this._oldTabIndex=this.tabIndex,this._setFocused(!1),this.tabIndex=-1,this.blur()):void 0!==this._oldTabIndex&&(this.tabIndex=this._oldTabIndex)},_changedControlState:function(){this._controlStateChanged&&this._controlStateChanged()}};D.IronBehaviors.IronButtonState={};
...
this._changedButtonState()},_changedButtonState:function(){this._buttonStateChanged&&this._buttonStateChanged()}};Polymer.IronButtonState=[Polymer.IronA11yKeysBehavior,Polymer.IronButtonStateImpl];D.PaperRipple={};D.PaperRipple.PaperRipple={};
...
get opacityDecayVelocity(){return this.element.opacityDecayVelocity},get radius(){var a=this.containerMetrics.width*this.containerMetrics.width,c=this.containerMetrics.height*this.containerMetrics.height;a=1.1*Math.min(Math.sqrt(a+c),b.MAX_RADIUS)+5;c=1.1-a/b.MAX_RADIUS*.2;c=this.mouseInteractionSeconds/c;a*=1-Math.pow(80,-c);return Math.abs(a)},get opacity(){return this.mouseUpStart?Math.max(0,this.initialOpacity-this.mouseUpElapsedSeconds*this.opacityDecayVelocity):this.initialOpacity},get outerOpacity(){var a=
.3*this.mouseUpElapsedSeconds,b=this.opacity;return Math.max(0,Math.min(a,b))},get isOpacityFullyDecayed(){return.01>this.opacity&&this.radius>=Math.min(this.maxRadius,b.MAX_RADIUS)},get isRestingAtMaxRadius(){return this.opacity>=this.initialOpacity&&this.radius>=Math.min(this.maxRadius,b.MAX_RADIUS)},get isAnimationComplete(){return this.mouseUpStart?this.isOpacityFullyDecayed:this.isRestingAtMaxRadius},get translationFraction(){return Math.min(1,this.radius/this.containerMetrics.size*2/Math.sqrt(2))},
get xNow(){return this.xEnd?this.xStart+this.translationFraction*(this.xEnd-this.xStart):this.xStart},get yNow(){return this.yEnd?this.yStart+this.translationFraction*(this.yEnd-this.yStart):this.yStart},get isMouseDown(){return this.mouseDownStart&&!this.mouseUpStart},resetInteractionState:function(){this.yEnd=this.xEnd=this.yStart=this.xStart=this.mouseUpStart=this.mouseDownStart=this.maxRadius=0;this.containerMetrics=new a(this.element)},draw:function(){this.wave.style.opacity=this.opacity;var a=
this.radius/(this.containerMetrics.size/2);var b=this.xNow-this.containerMetrics.width/2;var c=this.yNow-this.containerMetrics.height/2;this.waveContainer.style.webkitTransform="translate("+b+"px, "+c+"px)";this.waveContainer.style.transform="translate3d("+b+"px, "+c+"px, 0)";this.wave.style.webkitTransform="scale("+a+","+a+")";this.wave.style.transform="scale3d("+a+","+a+",1)"},downAction:function(a){var b=this.containerMetrics.width/2,d=this.containerMetrics.height/2;this.resetInteractionState();
this.mouseDownStart=c.now();this.center?(this.xStart=b,this.yStart=d):(this.xStart=a?a.detail.x-this.containerMetrics.boundingRect.left:this.containerMetrics.width/2,this.yStart=a?a.detail.y-this.containerMetrics.boundingRect.top:this.containerMetrics.height/2);this.recenters&&(this.xEnd=b,this.yEnd=d);this.maxRadius=this.containerMetrics.furthestCornerDistanceFrom(this.xStart,this.yStart);this.waveContainer.style.top=(this.containerMetrics.height-this.containerMetrics.size)/2+"px";this.waveContainer.style.left=
(this.containerMetrics.width-this.containerMetrics.size)/2+"px";this.waveContainer.style.width=this.containerMetrics.size+"px";this.waveContainer.style.height=this.containerMetrics.size+"px"},upAction:function(){this.isMouseDown&&(this.mouseUpStart=c.now())},remove:function(){Polymer.dom(this.waveContainer.parentNode).removeChild(this.waveContainer)}};Polymer({is:"paper-ripple",behaviors:[Polymer.IronA11yKeysBehavior],properties:{initialOpacity:{type:Number,value:.25},opacityDecayVelocity:{type:Number,
value:.8},recenters:{type:Boolean,value:!1},center:{type:Boolean,value:!1},ripples:{type:Array,value:function(){return[]}},animating:{type:Boolean,readOnly:!0,reflectToAttribute:!0,value:!1},holdDown:{type:Boolean,value:!1,observer:"_holdDownChanged"},noink:{type:Boolean,value:!1},_animating:{type:Boolean},_boundAnimate:{type:Function,value:function(){return this.animate.bind(this)}}},get target(){return this.keyEventTarget},keyBindings:{"enter:keydown":"_onEnterKeydown","space:keydown":"_onSpaceKeydown",
"space:keyup":"_onSpaceKeyup"},attached:function(){var a=this.keyEventTarget=11==this.parentNode.nodeType?Polymer.dom(this).getOwnerRoot().host:this.parentNode;this.listen(a,"up","uiUpAction");this.listen(a,"down","uiDownAction")},detached:function(){this.unlisten(this.keyEventTarget,"up","uiUpAction");this.unlisten(this.keyEventTarget,"down","uiDownAction");this.keyEventTarget=null},get shouldKeepAnimating(){for(var a=0;a<this.ripples.length;++a)if(!this.ripples[a].isAnimationComplete)return!0;return!1},
simulatedRipple:function(){this.downAction(null);this.async(function(){this.upAction()},1)},uiDownAction:function(a){this.noink||this.downAction(a)},downAction:function(a){if(!(this.holdDown&&0<this.ripples.length)){var b=this.addRipple();b.downAction(a);this._animating||(this._animating=!0,this.animate())}},uiUpAction:function(a){this.noink||this.upAction(a)},upAction:function(a){this.holdDown||(this.ripples.forEach(function(b){b.upAction(a)}),this._animating=!0,this.animate())},onAnimationComplete:function(){this._animating=
!1;this.$.background.style.backgroundColor=null;this.fire("transitionend")},addRipple:function(){var a=new b(this);Polymer.dom(this.$.waves).appendChild(a.waveContainer);this.$.background.style.backgroundColor=a.color;this.ripples.push(a);this._setAnimating(!0);return a},removeRipple:function(a){var b=this.ripples.indexOf(a);0>b||(this.ripples.splice(b,1),a.remove(),this.ripples.length||this._setAnimating(!1))},animate:function(){if(this._animating){var a;for(a=0;a<this.ripples.length;++a){var b=
this.ripples[a];b.draw();this.$.background.style.opacity=b.outerOpacity;b.isOpacityFullyDecayed&&!b.isRestingAtMaxRadius&&this.removeRipple(b)}if(this.shouldKeepAnimating||0!==this.ripples.length)window.requestAnimationFrame(this._boundAnimate);else this.onAnimationComplete()}},_onEnterKeydown:function(){this.uiDownAction();this.async(this.uiUpAction,1)},_onSpaceKeydown:function(){this.uiDownAction()},_onSpaceKeyup:function(){this.uiUpAction()},_holdDownChanged:function(a,b){void 0!==b&&(a?this.downAction():
this.upAction())}})})();D.PaperBehaviors={};D.PaperBehaviors.PaperRippleBehavior={};
...
Polymer.dom(this._rippleContainer||this);var c=Polymer.dom(a).rootTarget;b.deepContains(c)&&this._ripple.uiDownAction(a)}}},getRipple:function(){this.ensureRipple();return this._ripple},hasRipple:function(){return!!this._ripple},_createRipple:function(){return document.createElement("paper-ripple")},_noinkChanged:function(a){this.hasRipple()&&(this._ripple.noink=a)}};D.PaperBehaviors.PaperButtonBehavior={};
Polymer.PaperButtonBehaviorImpl={properties:{elevation:{type:Number,reflectToAttribute:!0,readOnly:!0}},observers:["_calculateElevation(focused, disabled, active, pressed, receivedFocusFromKeyboard)","_computeKeyboardClass(receivedFocusFromKeyboard)"],hostAttributes:{role:"button",tabindex:"0",animated:!0},_calculateElevation:function(){var a=1;this.disabled?a=0:this.active||this.pressed?a=4:this.receivedFocusFromKeyboard&&(a=3);this._setElevation(a)},_computeKeyboardClass:function(a){this.toggleClass("keyboard-focus",a)},
_spaceKeyDownHandler:function(a){Polymer.IronButtonStateImpl._spaceKeyDownHandler.call(this,a);this.hasRipple()&&1>this.getRipple().ripples.length&&this._ripple.uiDownAction()},_spaceKeyUpHandler:function(a){Polymer.IronButtonStateImpl._spaceKeyUpHandler.call(this,a);this.hasRipple()&&this._ripple.uiUpAction()}};Polymer.PaperButtonBehavior=[Polymer.IronButtonState,Polymer.IronControlState,Polymer.PaperRippleBehavior,Polymer.PaperButtonBehaviorImpl];D.PaperButton={};D.PaperButton.PaperButton={};Polymer({is:"paper-button",behaviors:[Polymer.PaperButtonBehavior],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){this.raised?Polymer.PaperButtonBehaviorImpl._calculateElevation.apply(this):this._setElevation(0)}});D.FontRoboto={};D.FontRoboto.Roboto={};D.IronFlexLayout.Classes={};D.IronFlexLayout.Classes.IronShadowFlexLayout={};console.warn("This file is deprecated. Please use `iron-flex-layout/iron-flex-layout-classes.html`, and one of the specific dom-modules instead");D.IronFlexLayout.Classes.IronFlexLayout={};console.warn("This file is deprecated. Please use `iron-flex-layout/iron-flex-layout-classes.html`, and one of the specific dom-modules instead");D.PaperStyles.Classes={};D.PaperStyles.Classes.Shadow={};D.PaperStyles.Classes.Typography={};D.PaperStyles.PaperStylesClasses={};D.PaperStyles.Classes.Global={};D.PaperStyles.Typography={};D.PaperStyles.DemoPages={};D.PaperStyles.ElementStyles={};D.PaperStyles.ElementStyles.PaperItemStyles={};D.PaperStyles.ElementStyles.PaperMaterialStyles={};D.PaperStyles.PaperStyles={};D.IronMeta={};D.IronMeta.IronMeta={};
...
if(b=this._cloneIcon(b,this.rtlMirroring&&this._targetIsRTL(a))){var c=Polymer.dom(a.root||a);c.insertBefore(b,c.childNodes[0]);return a._svgIcon=b}return null},removeIcon:function(a){a._svgIcon&&(Polymer.dom(a.root||a).removeChild(a._svgIcon),a._svgIcon=null)},_targetIsRTL:function(a){null==this.__targetIsRTL&&(this.useGlobalRtlAttribute?(a=document.body&&document.body.hasAttribute("dir")?document.body:document.documentElement,this.__targetIsRTL="rtl"===a.getAttribute("dir")):(a&&a.nodeType!==Node.ELEMENT_NODE&&
...
this.size,b)},_prepareSvgClone:function(a,b,c){if(a){a=a.cloneNode(!0);var d=document.createElementNS("http://www.w3.org/2000/svg","svg");b=a.getAttribute("viewBox")||"0 0 "+b+" "+b;var e="pointer-events: none; display: block; width: 100%; height: 100%;";c&&a.hasAttribute("mirror-in-rtl")&&(e+="-webkit-transform:scale(-1,1);transform:scale(-1,1);");d.setAttribute("viewBox",b);d.setAttribute("preserveAspectRatio","xMidYMid meet");d.setAttribute("focusable","false");d.style.cssText=e;d.appendChild(a).removeAttribute("id");
return d}return null}});D.IronSelector.IronMultiSelectable={};
...
_updateMultiselectable:function(a){a?this.setAttribute("aria-multiselectable","true"):this.removeAttribute("aria-multiselectable")},_focusWithKeyboardEvent:function(a){this.cancelDebouncer("_clearSearchText");var b=this._searchText||"";a=a.key&&1==a.key.length?a.key:String.fromCharCode(a.keyCode);b+=a.toLocaleLowerCase();a=b.length;for(var c=0,d;d=this.items[c];c++)if(!d.hasAttribute("disabled")){var e=this.attrForItemTitle||"textContent";e=(d[e]||d.getAttribute(e)||"").trim();if(!(e.length<a)&&e.slice(0,
...
Polymer.IronMenuBehaviorImpl._shiftTabPressed=!1;Polymer.IronMenuBehavior=[Polymer.IronMultiSelectableBehavior,Polymer.IronA11yKeysBehavior,Polymer.IronMenuBehaviorImpl];D.IronMenuBehavior.IronMenubarBehavior={};
...
b&&a.target!==b&&b.click()}}});D.PaperTabs.PaperTabsIcons={};D.PaperTabs.PaperTabs={};
...
*/
(function(){!function(a,b){var c={},d={},e={};!function(a){function b(a){if("number"==typeof a)return a;var b={},c;for(c in a)b[c]=a[c];return b}function c(){this._endDelay=this._delay=0;this._fill="none";this._iterationStart=0;this._iterations=1;this._duration=0;this._playbackRate=1;this._direction="normal";this._easing="linear";this._easingFunction=A}function d(){return a.isDeprecated("Invalid timing inputs","2016-03-02","TypeError exceptions will be thrown instead.",!0)}function e(b,d){var e=new c;
return d&&(e.fill="both",e.duration="auto"),"number"!=typeof b||isNaN(b)?void 0!==b&&Object.getOwnPropertyNames(b).forEach(function(c){"auto"==b[c]||("number"==typeof e[c]||"duration"==c)&&("number"!=typeof b[c]||isNaN(b[c]))||"fill"==c&&-1==C.indexOf(b[c])||"direction"==c&&-1==y.indexOf(b[c])||"playbackRate"==c&&1!==b[c]&&a.isDeprecated("AnimationEffectTiming.playbackRate","2014-11-28","Use Animation.playbackRate instead.")||(e[c]=b[c])}):e.duration=b,e}function f(a){return"number"==typeof a&&(a=
isNaN(a)?{duration:0}:{duration:a}),a}function t(b,c){return b=a.numericTimingToObject(b),e(b,c)}function v(a,b,c,d){return 0>a||1<a||0>c||1<c?A:function(e){if(0==e||1==e)return e;for(var h=0,f=1;;){var k=(h+f)/2,m=3*a*(1-k)*(1-k)*k+3*c*(1-k)*k*k+k*k*k;if(1E-4>Math.abs(e-m))return 3*b*(1-k)*(1-k)*k+3*d*(1-k)*k*k+k*k*k;e>m?h=k:f=k}}}function z(a,b){return function(c){if(1<=c)return 1;var d=1/a;return c+=b*d,c-c%d}}function B(a){E||(E=document.createElement("div").style);E.animationTimingFunction="";
E.animationTimingFunction=a;var b=E.animationTimingFunction;if(""==b&&d())throw new TypeError(a+" is not a valid value for easing");return(a=M.exec(b))?v.apply(this,a.slice(1).map(Number)):(a=N.exec(b))?z(Number(a[1]),{start:G,middle:H,end:I}[a[2]]):(b=O[b])?b:A}function q(a){return Math.abs(a.duration*a.iterations/a.playbackRate)}function u(a,b,c){return null==b?J:b<c.delay?F:b>=c.delay+a?K:L}function w(a,b,c){var d=u(a,b,c);a:{var e=c.fill;switch(d){case F:b="backwards"==e||"both"==e?0:null;break a;
case L:b-=c.delay;break a;case K:b="forwards"==e||"both"==e?a:null;break a;case J:b=null;break a}b=void 0}if(null===b)return null;if(0===a)return d===F?0:1;d=c.iterationStart*c.duration;b=(0>c.playbackRate?b-a:b)*c.playbackRate+d;a=c.duration;a=b===1/0||b===-(1/0)||b-d==c.duration*c.iterations&&c.iterations&&0==(c.iterations+c.iterationStart)%1?a:b%a;d=c.duration;b=0===b?0:a==d?c.iterationStart+c.iterations-1:Math.floor(b/d);d=c.duration;b=1<=b%2;a=(b="normal"==c.direction||c.direction==(b?"alternate-reverse":
"alternate"))?a:d-a;a/=d;a=d*c._easingFunction(a);return a/c.duration}var C=["backwards","forwards","both","none"],y=["reverse","alternate","alternate-reverse"],A=function(a){return a};c.prototype={_setMember:function(b,c){this["_"+b]=c;this._effect&&(this._effect._timingInput[b]=c,this._effect._timing=a.normalizeTimingInput(this._effect._timingInput),this._effect.activeDuration=a.calculateActiveDuration(this._effect._timing),this._effect._animation&&this._effect._animation._rebuildUnderlyingAnimation())},
...
set duration(a){if("auto"!=a&&(isNaN(a)||0>a)&&d())throw new TypeError("duration must be non-negative or auto, received: "+a);this._setMember("duration",a)},get duration(){return this._duration},set direction(a){this._setMember("direction",a)},get direction(){return this._direction},set easing(a){this._easingFunction=B(a);this._setMember("easing",a)},get easing(){return this._easing},set iterations(a){if((isNaN(a)||0>a)&&d())throw new TypeError("iterations must be non-negative, received: "+a);this._setMember("iterations",
a)},get iterations(){return this._iterations}};var G=1,H=.5,I=0,O={ease:v(.25,.1,.25,1),"ease-in":v(.42,0,1,1),"ease-out":v(0,0,.58,1),"ease-in-out":v(.42,0,.58,1),"step-start":z(1,G),"step-middle":z(1,H),"step-end":z(1,I)},E=null,M=/cubic-bezier\(\s*(-?\d+\.?\d*|-?\.\d+)\s*,\s*(-?\d+\.?\d*|-?\.\d+)\s*,\s*(-?\d+\.?\d*|-?\.\d+)\s*,\s*(-?\d+\.?\d*|-?\.\d+)\s*\)/,N=/steps\(\s*(\d+)\s*,\s*(start|middle|end)\s*\)/,J=0,F=1,K=2,L=3;a.cloneTimingInput=b;a.makeTiming=e;a.numericTimingToObject=f;a.normalizeTimingInput=
t;a.calculateActiveDuration=q;a.calculateTimeFraction=w;a.calculatePhase=u;a.toTimingFunction=B}(c,null);(function(a){function b(a){var b=[],c;for(c in a)if(!(c in["easing","offset","composite"])){var d=a[c];Array.isArray(d)||(d=[d]);for(var e,h=d.length,f=0;h>f;f++)e={},"offset"in a?e.offset=a.offset:1==h?e.offset=1:e.offset=f/(h-1),"easing"in a&&(e.easing=a.easing),"composite"in a&&(e.composite=a.composite),e[c]=d[f],b.push(e)}return b.sort(function(a,b){return a.offset-b.offset}),b}function c(a){function c(){var a=
h.length;null==h[a-1].offset&&(h[a-1].offset=1);1<a&&null==h[0].offset&&(h[0].offset=0);for(var b=0,c=h[0].offset,d=1;a>d;d++){var e=h[d].offset;if(null!=e){for(var f=1;d-b>f;f++)h[b+f].offset=c+(e-c)*f/(d-b);b=d;c=e}}}if(null==a)return[];window.Symbol&&Symbol.iterator&&Array.prototype.from&&a[Symbol.iterator]&&(a=Array.from(a));Array.isArray(a)||(a=b(a));var h=a.map(function(a){var b={},c;for(c in a){var h=a[c];if("offset"==c){if(null!=h&&(h=Number(h),!isFinite(h)))throw new TypeError("keyframe offsets must be numbers.");
}else{if("composite"==c)throw{type:DOMException.NOT_SUPPORTED_ERR,name:"NotSupportedError",message:"add compositing is not supported"};h=""+h}var f=void 0,k=c,m=h;h=b;var r=d[k];if(r)for(f in e.style[k]=m,r)k=r[f],m=e.style[k],h[k]=k in t?t[k][m]||m:m;else h[k]=k in t?t[k][m]||m:m}return void 0==b.offset&&(b.offset=null),b});a=!0;for(var f=-(1/0),k=0;k<h.length;k++){var m=h[k].offset;if(null!=m){if(f>m)throw{code:DOMException.INVALID_MODIFICATION_ERR,name:"InvalidModificationError",message:"Keyframes are not loosely sorted by offset. Sort or specify offsets."};
f=m}else a=!1}return h=h.filter(function(a){return 0<=a.offset&&1>=a.offset}),a||c(),h}var d={background:"backgroundImage backgroundPosition backgroundSize backgroundRepeat backgroundAttachment backgroundOrigin backgroundClip backgroundColor".split(" "),border:"borderTopColor borderTopStyle borderTopWidth borderRightColor borderRightStyle borderRightWidth borderBottomColor borderBottomStyle borderBottomWidth borderLeftColor borderLeftStyle borderLeftWidth".split(" "),borderBottom:["borderBottomWidth",
...
"borderLeftWidth"],flex:["flexGrow","flexShrink","flexBasis"],font:"fontFamily fontSize fontStyle fontVariant fontWeight lineHeight".split(" "),margin:["marginTop","marginRight","marginBottom","marginLeft"],outline:["outlineColor","outlineStyle","outlineWidth"],padding:["paddingTop","paddingRight","paddingBottom","paddingLeft"]},e=document.createElementNS("http://www.w3.org/1999/xhtml","div"),f={thin:"1px",medium:"3px",thick:"5px"},t={borderBottomWidth:f,borderLeftWidth:f,borderRightWidth:f,borderTopWidth:f,
fontSize:{"xx-small":"60%","x-small":"75%",small:"89%",medium:"100%",large:"120%","x-large":"150%","xx-large":"200%"},fontWeight:{normal:"400",bold:"700"},outlineWidth:f,textShadow:{none:"0px 0px 0px transparent"},boxShadow:{none:"0px 0px 0px 0px transparent"}};a.convertToArrayForm=b;a.normalizeKeyframes=c})(c,null);(function(a){var b={};a.isDeprecated=function(a,c,d,e){e=e?"are":"is";var h=new Date;c=new Date(c);return c.setMonth(c.getMonth()+3),c>h?(a in b||console.warn("Web Animations: "+a+" "+
e+" deprecated and will stop working on "+c.toDateString()+". "+d),b[a]=!0,!1):!0};a.deprecated=function(b,c,d,e){var h=e?"are":"is";if(a.isDeprecated(b,c,d,e))throw Error(b+" "+h+" no longer supported. "+d);}})(c);(function(){if(document.documentElement.animate){var a=document.documentElement.animate([],0),b=!0;if(a&&(b=!1,"play currentTime pause reverse playbackRate cancel finish startTime playState".split(" ").forEach(function(c){void 0===a[c]&&(b=!0)})),!b)return}!function(a,b){function c(a){for(var b=
{},c=0;c<a.length;c++)for(var d in a[c])if("offset"!=d&&"easing"!=d&&"composite"!=d){var e={offset:a[c].offset,easing:a[c].easing,value:a[c][d]};b[d]=b[d]||[];b[d].push(e)}for(var h in b)if(a=b[h],0!=a[0].offset||1!=a[a.length-1].offset)throw{type:DOMException.NOT_SUPPORTED_ERR,name:"NotSupportedError",message:"Partial keyframes are not supported"};return b}function d(c){var d=[],e;for(e in c)for(var h=c[e],f=0;f<h.length-1;f++){var k=h[f].offset,m=h[f+1].offset,r=h[f].value,t=h[f+1].value,l=h[f].easing;
k==m&&(1==m?r=t:t=r);d.push({startTime:k,endTime:m,easing:a.toTimingFunction(l?l:"linear"),property:e,interpolation:b.propertyInterpolation(e,r,t)})}return d.sort(function(a,b){return a.startTime-b.startTime}),d}b.convertEffectInput=function(e){e=a.normalizeKeyframes(e);var h=c(e),f=d(h);return function(a,c){if(null!=c)f.filter(function(a){return 0>=c&&0==a.startTime||1<=c&&1==a.endTime||c>=a.startTime&&c<=a.endTime}).forEach(function(d){var e=c-d.startTime,h=d.endTime-d.startTime;e=0==h?0:d.easing(e/
h);b.apply(a,d.property,d.interpolation(e))});else for(var d in h)"offset"!=d&&"easing"!=d&&"composite"!=d&&b.clear(a,d)}}}(c,d,null);(function(a,b){function c(a){return a.replace(/-(.)/g,function(a,b){return b.toUpperCase()})}function d(a,b,d){for(var e=0;e<d.length;e++){var f=d[e],k=a,m=b;f=c(f);h[f]=h[f]||[];h[f].push([k,m])}}function e(d,e,k){var m=d;/-/.test(d)&&!a.isDeprecated("Hyphenated property names","2016-03-22","Use camelCase instead.",!0)&&(m=c(d));"initial"!=e&&"initial"!=k||("initial"==
e&&(e=f[m]),"initial"==k&&(k=f[m]));d=e==k?[]:h[m];for(m=0;d&&m<d.length;m++){var r=d[m][0](e),l=d[m][0](k);if(void 0!==r&&void 0!==l&&(r=d[m][1](r,l))){var t=b.Interpolation.apply(null,r);return function(a){return 0==a?e:1==a?k:t(a)}}}return b.Interpolation(!1,!0,function(a){return a?k:e})}var h={};b.addPropertiesHandler=d;var f={backgroundColor:"transparent",backgroundPosition:"0% 0%",borderBottomColor:"currentColor",borderBottomLeftRadius:"0px",borderBottomRightRadius:"0px",borderBottomWidth:"3px",
borderLeftColor:"currentColor",borderLeftWidth:"3px",borderRightColor:"currentColor",borderRightWidth:"3px",borderSpacing:"2px",borderTopColor:"currentColor",borderTopLeftRadius:"0px",borderTopRightRadius:"0px",borderTopWidth:"3px",bottom:"auto",clip:"rect(0px, 0px, 0px, 0px)",color:"black",fontSize:"100%",fontWeight:"400",height:"auto",left:"auto",letterSpacing:"normal",lineHeight:"120%",marginBottom:"0px",marginLeft:"0px",marginRight:"0px",marginTop:"0px",maxHeight:"none",maxWidth:"none",minHeight:"0px",
minWidth:"0px",opacity:"1.0",outlineColor:"invert",outlineOffset:"0px",outlineWidth:"3px",paddingBottom:"0px",paddingLeft:"0px",paddingRight:"0px",paddingTop:"0px",right:"auto",textIndent:"0px",textShadow:"0px 0px 0px transparent",top:"auto",transform:"",verticalAlign:"0px",visibility:"visible",width:"auto",wordSpacing:"normal",zIndex:"auto"};b.propertyInterpolation=e})(c,d,null);(function(a,b){function c(b){var c=a.calculateActiveDuration(b),d=function(d){return a.calculateTimeFraction(c,d,b)};return d._totalDuration=
b.delay+c+b.endDelay,d._isCurrent=function(d){d=a.calculatePhase(c,d,b);return d===PhaseActive||d===PhaseBefore},d}b.KeyframeEffect=function(d,e,h,f){var k,m=c(a.normalizeTimingInput(h)),r=b.convertEffectInput(e);e=function(){r(d,k)};return e._update=function(a){return k=m(a),null!==k},e._clear=function(){r(d,null)},e._hasSameTarget=function(a){return d===a},e._isCurrent=m._isCurrent,e._totalDuration=m._totalDuration,e._id=f,e};b.NullEffect=function(a){var b=function(){a&&(a(),a=null)};return b._update=
function(){return null},b._totalDuration=0,b._isCurrent=function(){return!1},b._hasSameTarget=function(){return!1},b}})(c,d,null);(function(a){a.apply=function(b,c,d){b.style[a.propertyName(c)]=d};a.clear=function(b,c){b.style[a.propertyName(c)]=""}})(d,null);(function(a){window.Element.prototype.animate=function(b,c){var d="";return c&&c.id&&(d=c.id),a.timeline._play(a.KeyframeEffect(this,b,c,d))}})(d);(function(a){function b(a,c,d){if("number"==typeof a&&"number"==typeof c)return a*(1-d)+c*d;if("boolean"==
typeof a&&"boolean"==typeof c)return.5>d?a:c;if(a.length==c.length){for(var e=[],h=0;h<a.length;h++)e.push(b(a[h],c[h],d));return e}throw"Mismatched interpolation arguments "+a+":"+c;}a.Interpolation=function(a,c,d){return function(e){return d(b(a,c,e))}}})(d,null);(function(a,b){a.sequenceNumber=0;var c=function(a,b){this.target=a;this.currentTime=b;this.type="finish";this.cancelable=this.bubbles=!1;this.currentTarget=a;this.defaultPrevented=!1;this.eventPhase=Event.AT_TARGET;this.timeStamp=Date.now()};
b.Animation=function(b){this.id="";b&&b._id&&(this.id=b._id);this._sequenceNumber=a.sequenceNumber++;this._currentTime=0;this._startTime=null;this._paused=!1;this._playbackRate=1;this._finishedFlag=this._inTimeline=!0;this.onfinish=null;this._finishHandlers=[];this._effect=b;this._inEffect=this._effect._update(0);this._idle=!0;this._currentTimePending=!1};b.Animation.prototype={_ensureAlive:function(){0>this.playbackRate&&0===this.currentTime?this._inEffect=this._effect._update(-1):this._inEffect=
this._effect._update(this.currentTime);this._inTimeline||!this._inEffect&&this._finishedFlag||(this._inTimeline=!0,b.timeline._animations.push(this))},_tickCurrentTime:function(a,b){a!=this._currentTime&&(this._currentTime=a,this._isFinished&&!b&&(this._currentTime=0<this._playbackRate?this._totalDuration:0),this._ensureAlive())},get currentTime(){return this._idle||this._currentTimePending?null:this._currentTime},set currentTime(a){a=+a;isNaN(a)||(b.restart(),this._paused||null==this._startTime||
(this._startTime=this._timeline.currentTime-a/this._playbackRate),this._currentTimePending=!1,this._currentTime!=a&&(this._tickCurrentTime(a,!0),b.invalidateEffects()))},get startTime(){return this._startTime},set startTime(a){a=+a;isNaN(a)||this._paused||this._idle||(this._startTime=a,this._tickCurrentTime((this._timeline.currentTime-this._startTime)*this.playbackRate),b.invalidateEffects())},get playbackRate(){return this._playbackRate},set playbackRate(a){if(a!=this._playbackRate){var b=this.currentTime;
this._playbackRate=a;this._startTime=null;"paused"!=this.playState&&"idle"!=this.playState&&this.play();null!=b&&(this.currentTime=b)}},get _isFinished(){return!this._idle&&(0<this._playbackRate&&this._currentTime>=this._totalDuration||0>this._playbackRate&&0>=this._currentTime)},get _totalDuration(){return this._effect._totalDuration},get playState(){return this._idle?"idle":null==this._startTime&&!this._paused&&0!=this.playbackRate||this._currentTimePending?"pending":this._paused?"paused":this._isFinished?
"finished":"running"},play:function(){this._paused=!1;(this._isFinished||this._idle)&&(this._currentTime=0<this._playbackRate?0:this._totalDuration,this._startTime=null);this._idle=this._finishedFlag=!1;this._ensureAlive();b.invalidateEffects()},pause:function(){this._isFinished||this._paused||this._idle||(this._currentTimePending=!0);this._startTime=null;this._paused=!0},finish:function(){this._idle||(this.currentTime=0<this._playbackRate?this._totalDuration:0,this._startTime=this._totalDuration-
this.currentTime,this._currentTimePending=!1,b.invalidateEffects())},cancel:function(){this._inEffect&&(this._inEffect=!1,this._idle=!0,this._finishedFlag=!0,this.currentTime=0,this._startTime=null,this._effect._update(null),b.invalidateEffects())},reverse:function(){this.playbackRate*=-1;this.play()},addEventListener:function(a,b){"function"==typeof b&&"finish"==a&&this._finishHandlers.push(b)},removeEventListener:function(a,b){"finish"==a&&(a=this._finishHandlers.indexOf(b),0<=a&&this._finishHandlers.splice(a,
1))},_fireEvents:function(a){if(this._isFinished){if(!this._finishedFlag){var b=new c(this,this._currentTime,a),d=this._finishHandlers.concat(this.onfinish?[this.onfinish]:[]);setTimeout(function(){d.forEach(function(a){a.call(b.target,b)})},0);this._finishedFlag=!0}}else this._finishedFlag=!1},_tick:function(a,b){this._idle||this._paused||(null==this._startTime?b&&(this.startTime=a-this._currentTime/this.playbackRate):this._isFinished||this._tickCurrentTime((a-this._startTime)*this.playbackRate));
b&&(this._currentTimePending=!1,this._fireEvents(a))},get _needsTick(){return this.playState in{pending:1,running:1}||!this._finishedFlag}}})(c,d,null);(function(a,b){function c(a){var b=l;l=[];a<A.currentTime&&(a=A.currentTime);f(a,!0);b.forEach(function(b){b[1](a)});h()}function d(a,b){return a._sequenceNumber-b._sequenceNumber}function e(){this._animations=[];this.currentTime=window.performance&&performance.now?performance.now():0}function h(){y.forEach(function(a){a()});y.length=0}function f(a,
c){C=!1;var e=b.timeline;e.currentTime=a;e._animations.sort(d);w=!1;var h=e._animations;e._animations=[];var f=[],k=[];h=h.filter(function(b){b._tick(a,c);b._inEffect?k.push(b._effect):f.push(b._effect);b._needsTick&&(w=!0);var d=b._inEffect||b._needsTick;return b._inTimeline=d,d});y.push.apply(y,f);y.push.apply(y,k);e._animations.push.apply(e._animations,h);w&&requestAnimationFrame(function(){})}var k=window.requestAnimationFrame,l=[],u=0;window.requestAnimationFrame=function(a){var b=u++;return 0==
l.length&&k(c),l.push([b,a]),b};window.cancelAnimationFrame=function(a){l.forEach(function(b){b[0]==a&&(b[1]=function(){})})};e.prototype={_play:function(c){c._timing=a.normalizeTimingInput(c.timing);c=new b.Animation(c);return c._idle=!1,c._timeline=this,this._animations.push(c),b.restart(),b.invalidateEffects(),c}};var w=!1,C=!1;b.restart=function(){return w||(w=!0,requestAnimationFrame(function(){}),C=!0),C};b.invalidateEffects=function(){f(b.timeline.currentTime,!1);h()};var y=[],A=new e;b.timeline=
A})(c,d,null);(function(a){function b(a,b){var c=a.exec(b);return c?(c=a.ignoreCase?c[0].toLowerCase():c[0],[c,b.substr(c.length)]):void 0}function c(a,b){b=b.replace(/^\s*/,"");return(a=a(b))?[a[0],a[1].replace(/^\s*/,"")]:void 0}function d(a,d,e){a=c.bind(null,a);for(var h=[];;){var f=a(e);if(!f||(h.push(f[0]),e=f[1],f=b(d,e),!f||""==f[1]))return[h,e];e=f[1]}}function e(a,b){for(var c=0,d=0;d<b.length&&(!/\s|,/.test(b[d])||0!=c);d++)if("("==b[d])c++;else if(")"==b[d]&&(c--,0==c&&d++,0>=c))break;
a=a(b.substr(0,d));return void 0==a?void 0:[a,b.substr(d)]}function h(a,b){for(var c=a,d=b;c&&d;)c>d?c%=d:d%=c;return a*b/(c+d)}function f(a){return function(b){b=a(b);return b&&(b[0]=void 0),b}}function l(a,b){return function(c){var d=a(c);return d?d:[b,c]}}function q(b,c){for(var d=[],e=0;e<b.length;e++){c=a.consumeTrimmed(b[e],c);if(!c||""==c[0])return;void 0!==c[0]&&d.push(c[0]);c=c[1]}return""==c?d:void 0}function u(a,b,c,d,e){for(var f=[],k=[],m=[],l=h(d.length,e.length),r=0;l>r;r++){var t=
b(d[r%d.length],e[r%e.length]);if(!t)return;f.push(t[0]);k.push(t[1]);m.push(t[2])}return[f,k,function(b){b=b.map(function(a,b){return m[b](a)}).join(c);return a?a(b):b}]}function w(a,b,c){for(var d=[],e=[],h=[],f=0,k=0;k<c.length;k++)if("function"==typeof c[k]){var m=c[k](a[f],b[f++]);d.push(m[0]);e.push(m[1]);h.push(m[2])}else!function(a){d.push(!1);e.push(!1);h.push(function(){return c[a]})}(k);return[d,e,function(a){for(var b="",c=0;c<a.length;c++)b+=h[c](a[c]);return b}]}a.consumeToken=b;a.consumeTrimmed=
c;a.consumeRepeated=d;a.consumeParenthesised=e;a.ignore=f;a.optional=l;a.consumeList=q;a.mergeNestedRepeated=u.bind(null,null);a.mergeWrappedNestedRepeated=u;a.mergeList=w})(d);(function(a){function b(b){function c(b){var c=a.consumeToken(/^inset/i,b);return c?(d.inset=!0,c):(c=a.consumeLengthOrPercent(b))?(d.lengths.push(c[0]),c):(c=a.consumeColor(b))?(d.color=c[0],c):void 0}var d={inset:!1,lengths:[],color:null};return(b=a.consumeRepeated(c,/^/,b))&&b[0].length?[d,b[1]]:void 0}function c(c){return(c=
a.consumeRepeated(b,/^,/,c))&&""==c[1]?c[0]:void 0}function d(b,c){for(;b.lengths.length<Math.max(b.lengths.length,c.lengths.length);)b.lengths.push({px:0});for(;c.lengths.length<Math.max(b.lengths.length,c.lengths.length);)c.lengths.push({px:0});if(b.inset==c.inset&&!!b.color==!!c.color){for(var d,e=[],h=[[],0],f=[[],0],k=0;k<b.lengths.length;k++){var m=a.mergeDimensions(b.lengths[k],c.lengths[k],2==k);h[0].push(m[0]);f[0].push(m[1]);e.push(m[2])}b.color&&c.color&&(c=a.mergeColors(b.color,c.color),
h[1]=c[0],f[1]=c[1],d=c[2]);return[h,f,function(a){for(var c=b.inset?"inset ":" ",h=0;h<e.length;h++)c+=e[h](a[0][h])+" ";return d&&(c+=d(a[1])),c}]}}function e(b,c,d,e){function h(a){return{inset:a,color:[0,0,0,0],lengths:[{px:0},{px:0},{px:0},{px:0}]}}for(var f=[],k=[],m=0;m<d.length||m<e.length;m++){var l=d[m]||h(e[m].inset),r=e[m]||h(d[m].inset);f.push(l);k.push(r)}return a.mergeNestedRepeated(b,c,f,k)}var h=e.bind(null,d,", ");a.addPropertiesHandler(c,h,["box-shadow","text-shadow"])})(d);(function(a){function b(a){return a.toFixed(3).replace(".000",
"")}function c(a,b,c){return Math.min(b,Math.max(a,c))}function d(a){return/^\s*[-+]?(\d*\.)?\d+\s*$/.test(a)?Number(a):void 0}function e(a,c){return[a,c,b]}function h(a,b){return 0!=a?l(0,1/0)(a,b):void 0}function f(a,b){return[a,b,function(a){return Math.round(c(1,1/0,a))}]}function l(a,d){return function(e,h){return[e,h,function(e){return b(c(a,d,e))}]}}function q(a,b){return[a,b,Math.round]}a.clamp=c;a.addPropertiesHandler(d,l(0,1/0),["border-image-width","line-height"]);a.addPropertiesHandler(d,
l(0,1),["opacity","shape-image-threshold"]);a.addPropertiesHandler(d,h,["flex-grow","flex-shrink"]);a.addPropertiesHandler(d,f,["orphans","widows"]);a.addPropertiesHandler(d,q,["z-index"]);a.parseNumber=d;a.mergeNumbers=e;a.numberToString=b})(d,null);(function(a){function b(a,b){return"visible"==a||"visible"==b?[0,1,function(c){return 0>=c?a:1<=c?b:"visible"}]:void 0}a.addPropertiesHandler(String,b,["visibility"])})(d);(function(a){function b(a){a=a.trim();e.fillStyle="#000";e.fillStyle=a;var b=e.fillStyle;
if(e.fillStyle="#fff",e.fillStyle=a,b==e.fillStyle)return e.fillRect(0,0,1,1),a=e.getImageData(0,0,1,1).data,e.clearRect(0,0,1,1),b=a[3]/255,[a[0]*b,a[1]*b,a[2]*b,b]}function c(b,c){return[b,c,function(b){if(b[3])for(var c=0;3>c;c++)b[c]=Math.round(Math.max(0,Math.min(255,b[c]/b[3])));return b[3]=a.numberToString(a.clamp(0,1,b[3])),"rgba("+b.join(",")+")"}]}var d=document.createElementNS("http://www.w3.org/1999/xhtml","canvas");d.width=d.height=1;var e=d.getContext("2d");a.addPropertiesHandler(b,
c,"background-color border-bottom-color border-left-color border-right-color border-top-color color outline-color text-decoration-color".split(" "));a.consumeColor=a.consumeParenthesised.bind(null,b);a.mergeColors=c})(d,null);(function(a){function b(a,b){if(b=b.trim().toLowerCase(),"0"==b&&0<="px".search(a))return{px:0};if(/^[^(]*$|^calc/.test(b)){b=b.replace(/calc\(/g,"(");var c={};b=b.replace(a,function(a){return c[a]=null,"U"+a});a="U("+a.source+")";for(var d=b.replace(/[-+]?(\d*\.)?\d+/g,"N").replace(new RegExp("N"+
a,"g"),"D").replace(/\s[+-]\s/g,"O").replace(/\s/g,""),e=[/N\*(D)/g,/(N|D)[*\/]N/g,/(N|D)O\1/g,/\((N|D)\)/g],f=0;f<e.length;)e[f].test(d)?(d=d.replace(e[f],"$1"),f=0):f++;if("D"==d){for(var h in c){d=eval(b.replace(new RegExp("U"+h,"g"),"").replace(new RegExp(a,"g"),"*0"));if(!isFinite(d))return;c[h]=d}return c}}}function c(a,b){return d(a,b,!0)}function d(b,c,d){var e,f=[];for(e in b)f.push(e);for(e in c)0>f.indexOf(e)&&f.push(e);return b=f.map(function(a){return b[a]||0}),c=f.map(function(a){return c[a]||
0}),[b,c,function(b){var c=b.map(function(c,e){return 1==b.length&&d&&(c=Math.max(c,0)),a.numberToString(c)+f[e]}).join(" + ");return 1<b.length?"calc("+c+")":c}]}var e=b.bind(null,/px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc/g),f=b.bind(null,/px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|%/g),h=b.bind(null,/deg|rad|grad|turn/g);a.parseLength=e;a.parseLengthOrPercent=f;a.consumeLengthOrPercent=a.consumeParenthesised.bind(null,f);a.parseAngle=h;a.mergeDimensions=d;e=a.consumeParenthesised.bind(null,
e);e=a.consumeRepeated.bind(void 0,e,/^/);var l=a.consumeRepeated.bind(void 0,e,/^,/);a.consumeSizePairList=l;e=function(a){return(a=l(a))&&""==a[1]?a[0]:void 0};h=a.mergeNestedRepeated.bind(void 0,c," ");var q=a.mergeNestedRepeated.bind(void 0,h,",");a.mergeNonNegativeSizePair=h;a.addPropertiesHandler(e,q,["background-size"]);a.addPropertiesHandler(f,c,"border-bottom-width border-image-width border-left-width border-right-width border-top-width flex-basis font-size height line-height max-height max-width outline-width width".split(" "));
a.addPropertiesHandler(f,d,"border-bottom-left-radius border-bottom-right-radius border-top-left-radius border-top-right-radius bottom left letter-spacing margin-bottom margin-left margin-right margin-top min-height min-width outline-offset padding-bottom padding-left padding-right padding-top perspective right shape-margin text-indent top vertical-align word-spacing".split(" "))})(d,null);(function(a){function b(b){return a.consumeLengthOrPercent(b)||a.consumeToken(/^auto/,b)}function c(c){return(c=
a.consumeList([a.ignore(a.consumeToken.bind(null,/^rect/)),a.ignore(a.consumeToken.bind(null,/^\(/)),a.consumeRepeated.bind(null,b,/^,/),a.ignore(a.consumeToken.bind(null,/^\)/))],c))&&4==c[0].length?c[0]:void 0}function d(b,c){return"auto"==b||"auto"==c?[!0,!1,function(d){d=d?b:c;if("auto"==d)return"auto";d=a.mergeDimensions(d,d);return d[2](d[0])}]:a.mergeDimensions(b,c)}function e(a){return"rect("+a+")"}var f=a.mergeWrappedNestedRepeated.bind(null,e,d,", ");a.parseBox=c;a.mergeBoxes=f;a.addPropertiesHandler(c,
f,["clip"])})(d,null);(function(a){function b(a){return function(b){var c=0;return a.map(function(a){return a===q?b[c++]:a})}}function c(a){return a}function d(b){if(b=b.toLowerCase().trim(),"none"==b)return[];for(var c,d=/\s*(\w+)\(([^)]*)\)/g,e=[],f=0;(c=d.exec(b))&&c.index==f;){f=c.index+c[0].length;var h=c[1],k=C[h];if(!k)break;c=c[2].split(",");k=k[0];if(k.length<c.length)break;for(var m=[],l=0;l<k.length;l++){var r,t=c[l],B=k[l];if(r=t?{A:function(b){return"0"==b.trim()?w:a.parseAngle(b)},N:a.parseNumber,
T:a.parseLengthOrPercent,L:a.parseLength}[B.toUpperCase()](t):{a:w,n:m[0],t:u}[B],void 0===r)return;m.push(r)}if(e.push({t:h,d:m}),d.lastIndex==b.length)return e}}function e(a){return a.toFixed(6).replace(".000000","")}function f(b,c){if(b.decompositionPair!==c){b.decompositionPair=c;var d=a.makeMatrixDecomposition(b)}if(c.decompositionPair!==b){c.decompositionPair=b;var f=a.makeMatrixDecomposition(c)}return null==d[0]||null==f[0]?[[!1],[!0],function(a){return a?c[0].d:b[0].d}]:(d[0].push(0),f[0].push(1),
[d,f,function(b){var c=a.quat(d[0][3],f[0][3],b[5]);b=a.composeMatrix(b[0],b[1],b[2],c,b[4]);return b=b.map(e).join(",")}])}function h(a){return a.replace(/(x|y|z|3d)?$/,"3d")}function l(b,c){var d=a.makeMatrixDecomposition&&!0,e=!1;if(!b.length||!c.length){b.length||(e=!0,b=c,c=[]);for(var k=0;k<b.length;k++){var m=b[k].t,l=b[k].d,r="scale"==m.substr(0,5)?1:0;c.push({t:m,d:l.map(function(a){if("number"==typeof a)return r;var b={},c;for(c in a)b[c]=r;return b})})}}l=[];var t=[],B=[];if(b.length!=
c.length){if(!d)return;var q=f(b,c);l=[q[0]];t=[q[1]];B=[["matrix",[q[2]]]]}else for(k=0;k<b.length;k++){m=b[k].t;var v=c[k].t,u=b[k].d,w=c[k].d,z=C[m],y=C[v];if("perspective"==m&&"perspective"==v||!("matrix"!=m&&"matrix3d"!=m||"matrix"!=v&&"matrix3d"!=v)){if(!d)return;q=f([b[k]],[c[k]]);l.push(q[0]);t.push(q[1]);B.push(["matrix",[q[2]]])}else{if(m!=v)if(z[2]&&y[2]&&m.replace(/[xy]/,"")==v.replace(/[xy]/,""))m=m.replace(/[xy]/,""),u=z[2](u),w=y[2](w);else{if(!z[1]||!y[1]||h(m)!=h(v)){if(!d)return;
q=f(b,c);l=[q[0]];t=[q[1]];B=[["matrix",[q[2]]]];break}m=h(m);u=z[1](u);w=y[1](w)}z=[];y=[];v=[];for(var A=0;A<u.length;A++)q="number"==typeof u[A]?a.mergeNumbers:a.mergeDimensions,q=q(u[A],w[A]),z[A]=q[0],y[A]=q[1],v.push(q[2]);l.push(z);t.push(y);B.push([m,v])}}e&&(b=l,l=t,t=b);return[l,t,function(a){return a.map(function(a,b){a=a.map(function(a,c){return B[b][1][c](a)}).join(",");return"matrix"==B[b][0]&&16==a.split(",").length&&(B[b][0]="matrix3d"),B[b][0]+"("+a+")"}).join(" ")}]}var q=null,u=
{px:0},w={deg:0},C={matrix:["NNNNNN",[q,q,0,0,q,q,0,0,0,0,1,0,q,q,0,1],c],matrix3d:["NNNNNNNNNNNNNNNN",c],rotate:["A"],rotatex:["A"],rotatey:["A"],rotatez:["A"],rotate3d:["NNNA"],perspective:["L"],scale:["Nn",b([q,q,1]),c],scalex:["N",b([q,1,1]),b([q,1])],scaley:["N",b([1,q,1]),b([1,q])],scalez:["N",b([1,1,q])],scale3d:["NNN",c],skew:["Aa",null,c],skewx:["A",null,b([q,w])],skewy:["A",null,b([w,q])],translate:["Tt",b([q,q,u]),c],translatex:["T",b([q,u,u]),b([q,u])],translatey:["T",b([u,q,u]),b([u,
q])],translatez:["L",b([u,u,q])],translate3d:["TTL",c]};a.addPropertiesHandler(d,l,["transform"])})(d,null);(function(a){function b(a,b){b.concat([a]).forEach(function(b){b in document.documentElement.style&&(c[a]=b)})}var c={};b("transform",["webkitTransform","msTransform"]);b("transformOrigin",["webkitTransformOrigin"]);b("perspective",["webkitPerspective"]);b("perspectiveOrigin",["webkitPerspectiveOrigin"]);a.propertyName=function(a){return c[a]||a}})(d,null)})();!function(){if(void 0===document.createElement("div").animate([]).oncancel){var a=
window.performance&&performance.now?function(){return performance.now()}:function(){return Date.now()};var b=function(a,b){this.target=a;this.currentTime=b;this.type="cancel";this.cancelable=this.bubbles=!1;this.currentTarget=a;this.defaultPrevented=!1;this.eventPhase=Event.AT_TARGET;this.timeStamp=Date.now()},c=window.Element.prototype.animate;window.Element.prototype.animate=function(d,e){d=c.call(this,d,e);d._cancelHandlers=[];d.oncancel=null;var f=d.cancel;d.cancel=function(){f.call(this);var c=
new b(this,null,a()),d=this._cancelHandlers.concat(this.oncancel?[this.oncancel]:[]);setTimeout(function(){d.forEach(function(a){a.call(c.target,c)})},0)};var h=d.addEventListener;d.addEventListener=function(a,b){"function"==typeof b&&"cancel"==a?this._cancelHandlers.push(b):h.call(this,a,b)};var k=d.removeEventListener;return d.removeEventListener=function(a,b){"cancel"==a?(a=this._cancelHandlers.indexOf(b),0<=a&&this._cancelHandlers.splice(a,1)):k.call(this,a,b)},d}}}();(function(a){var b=document.documentElement,
c=null,d=!1;try{var e=getComputedStyle(b).getPropertyValue("opacity");e="0"==e?"1":"0";c=b.animate({opacity:[e,e]},{duration:1});c.currentTime=0;d=getComputedStyle(b).getPropertyValue("opacity")==e}catch(t){}finally{c&&c.cancel()}if(!d){var f=window.Element.prototype.animate;window.Element.prototype.animate=function(b,c){return window.Symbol&&Symbol.iterator&&Array.prototype.from&&b[Symbol.iterator]&&(b=Array.from(b)),Array.isArray(b)||null===b||(b=a.convertToArrayForm(b)),f.call(this,b,c)}}})(c);
!function(a,b){function c(a){var b=window.document.timeline;b.currentTime=a;b._discardAnimations();0==b._animations.length?e=!1:requestAnimationFrame(c)}var d=window.requestAnimationFrame;window.requestAnimationFrame=function(a){return d(function(b){window.document.timeline._updateAnimationsPromises();a(b);window.document.timeline._updateAnimationsPromises()})};b.AnimationTimeline=function(){this._animations=[];this.currentTime=void 0};b.AnimationTimeline.prototype={getAnimations:function(){return this._discardAnimations(),
this._animations.slice()},_updateAnimationsPromises:function(){b.animationsWithPromises=b.animationsWithPromises.filter(function(a){return a._updatePromises()})},_discardAnimations:function(){this._updateAnimationsPromises();this._animations=this._animations.filter(function(a){return"finished"!=a.playState&&"idle"!=a.playState})},_play:function(a){a=new b.Animation(a,this);return this._animations.push(a),b.restartWebAnimationsNextTick(),a._updatePromises(),a._animation.play(),a._updatePromises(),
a},play:function(a){return a&&a.remove(),this._play(a)}};var e=!1;b.restartWebAnimationsNextTick=function(){e||(e=!0,requestAnimationFrame(c))};var f=new b.AnimationTimeline;b.timeline=f;try{Object.defineProperty(window.document,"timeline",{configurable:!0,get:function(){return f}})}catch(t){}try{window.document.timeline=f}catch(t){}}(c,e,null);(function(a,b){b.animationsWithPromises=[];b.Animation=function(b,c){if(this.id="",b&&b._id&&(this.id=b._id),this.effect=b,b&&(b._animation=this),!c)throw Error("Animation with null timeline is not supported");
this._timeline=c;this._sequenceNumber=a.sequenceNumber++;this._holdTime=0;this._isGroup=this._paused=!1;this._animation=null;this._childAnimations=[];this._callback=null;this._oldPlayState="idle";this._rebuildUnderlyingAnimation();this._animation.cancel();this._updatePromises()};b.Animation.prototype={_updatePromises:function(){var a=this._oldPlayState,b=this.playState;return this._readyPromise&&b!==a&&("idle"==b?(this._rejectReadyPromise(),this._readyPromise=void 0):"pending"==a?this._resolveReadyPromise():
"pending"==b&&(this._readyPromise=void 0)),this._finishedPromise&&b!==a&&("idle"==b?(this._rejectFinishedPromise(),this._finishedPromise=void 0):"finished"==b?this._resolveFinishedPromise():"finished"==a&&(this._finishedPromise=void 0)),this._oldPlayState=this.playState,this._readyPromise||this._finishedPromise},_rebuildUnderlyingAnimation:function(){this._updatePromises();var a,c,d,e,f=!!this._animation;f&&(a=this.playbackRate,c=this._paused,d=this.startTime,e=this.currentTime,this._animation.cancel(),
this._animation._wrapper=null,this._animation=null);(!this.effect||this.effect instanceof window.KeyframeEffect)&&(this._animation=b.newUnderlyingAnimationForKeyframeEffect(this.effect),b.bindAnimationForKeyframeEffect(this));(this.effect instanceof window.SequenceEffect||this.effect instanceof window.GroupEffect)&&(this._animation=b.newUnderlyingAnimationForGroup(this.effect),b.bindAnimationForGroup(this));this.effect&&this.effect._onsample&&b.bindAnimationForCustomEffect(this);f&&(1!=a&&(this.playbackRate=
a),null!==d?this.startTime=d:null!==e?this.currentTime=e:null!==this._holdTime&&(this.currentTime=this._holdTime),c&&this.pause());this._updatePromises()},_updateChildren:function(){if(this.effect&&"idle"!=this.playState){var a=this.effect._timing.delay;this._childAnimations.forEach(function(c){this._arrangeChildren(c,a);this.effect instanceof window.SequenceEffect&&(a+=b.groupChildDuration(c.effect))}.bind(this))}},_setExternalAnimation:function(a){if(this.effect&&this._isGroup)for(var b=0;b<this.effect.children.length;b++)this.effect.children[b]._animation=
a,this._childAnimations[b]._setExternalAnimation(a)},_constructChildAnimations:function(){if(this.effect&&this._isGroup){var a=this.effect._timing.delay;this._removeChildAnimations();this.effect.children.forEach(function(c){var d=window.document.timeline._play(c);this._childAnimations.push(d);d.playbackRate=this.playbackRate;this._paused&&d.pause();c._animation=this.effect._animation;this._arrangeChildren(d,a);this.effect instanceof window.SequenceEffect&&(a+=b.groupChildDuration(c))}.bind(this))}},
_arrangeChildren:function(a,b){null===this.startTime?a.currentTime=this.currentTime-b/this.playbackRate:a.startTime!==this.startTime+b/this.playbackRate&&(a.startTime=this.startTime+b/this.playbackRate)},get timeline(){return this._timeline},get playState(){return this._animation?this._animation.playState:"idle"},get finished(){return window.Promise?(this._finishedPromise||(-1==b.animationsWithPromises.indexOf(this)&&b.animationsWithPromises.push(this),this._finishedPromise=new Promise(function(a,
b){this._resolveFinishedPromise=function(){a(this)};this._rejectFinishedPromise=function(){b({type:DOMException.ABORT_ERR,name:"AbortError"})}}.bind(this)),"finished"==this.playState&&this._resolveFinishedPromise()),this._finishedPromise):(console.warn("Animation Promises require JavaScript Promise constructor"),null)},get ready(){return window.Promise?(this._readyPromise||(-1==b.animationsWithPromises.indexOf(this)&&b.animationsWithPromises.push(this),this._readyPromise=new Promise(function(a,b){this._resolveReadyPromise=
function(){a(this)};this._rejectReadyPromise=function(){b({type:DOMException.ABORT_ERR,name:"AbortError"})}}.bind(this)),"pending"!==this.playState&&this._resolveReadyPromise()),this._readyPromise):(console.warn("Animation Promises require JavaScript Promise constructor"),null)},get onfinish(){return this._animation.onfinish},set onfinish(a){"function"==typeof a?this._animation.onfinish=function(b){b.target=this;a.call(this,b)}.bind(this):this._animation.onfinish=a},get oncancel(){return this._animation.oncancel},
set oncancel(a){"function"==typeof a?this._animation.oncancel=function(b){b.target=this;a.call(this,b)}.bind(this):this._animation.oncancel=a},get currentTime(){this._updatePromises();var a=this._animation.currentTime;return this._updatePromises(),a},set currentTime(a){this._updatePromises();this._animation.currentTime=isFinite(a)?a:Math.sign(a)*Number.MAX_VALUE;this._register();this._forEachChild(function(b,c){b.currentTime=a-c});this._updatePromises()},get startTime(){return this._animation.startTime},
set startTime(a){this._updatePromises();this._animation.startTime=isFinite(a)?a:Math.sign(a)*Number.MAX_VALUE;this._register();this._forEachChild(function(b,c){b.startTime=a+c});this._updatePromises()},get playbackRate(){return this._animation.playbackRate},set playbackRate(a){this._updatePromises();var b=this.currentTime;this._animation.playbackRate=a;this._forEachChild(function(b){b.playbackRate=a});"paused"!=this.playState&&"idle"!=this.playState&&this.play();null!==b&&(this.currentTime=b);this._updatePromises()},
play:function(){this._updatePromises();this._paused=!1;this._animation.play();-1==this._timeline._animations.indexOf(this)&&this._timeline._animations.push(this);this._register();b.awaitStartTime(this);this._forEachChild(function(a){var b=a.currentTime;a.play();a.currentTime=b});this._updatePromises()},pause:function(){this._updatePromises();this.currentTime&&(this._holdTime=this.currentTime);this._animation.pause();this._register();this._forEachChild(function(a){a.pause()});this._paused=!0;this._updatePromises()},
finish:function(){this._updatePromises();this._animation.finish();this._register();this._updatePromises()},cancel:function(){this._updatePromises();this._animation.cancel();this._register();this._removeChildAnimations();this._updatePromises()},reverse:function(){this._updatePromises();var a=this.currentTime;this._animation.reverse();this._forEachChild(function(a){a.reverse()});null!==a&&(this.currentTime=a);this._updatePromises()},addEventListener:function(a,b){var c=b;"function"==typeof b&&(c=function(a){a.target=
this;b.call(this,a)}.bind(this),b._wrapper=c);this._animation.addEventListener(a,c)},removeEventListener:function(a,b){this._animation.removeEventListener(a,b&&b._wrapper||b)},_removeChildAnimations:function(){for(;this._childAnimations.length;)this._childAnimations.pop().cancel()},_forEachChild:function(b){var c=0;if(this.effect.children&&this._childAnimations.length<this.effect.children.length&&this._constructChildAnimations(),this._childAnimations.forEach(function(a){b.call(this,a,c);this.effect instanceof
window.SequenceEffect&&(c+=a.effect.activeDuration)}.bind(this)),"pending"!=this.playState){var d=this.effect._timing,e=this.currentTime;null!==e&&(e=a.calculateTimeFraction(a.calculateActiveDuration(d),e,d));(null==e||isNaN(e))&&this._removeChildAnimations()}}};window.Animation=b.Animation})(c,e,null);(function(a,b){function c(b){this._frames=a.normalizeKeyframes(b)}function d(){for(var a=!1;v.length;)a=v.shift(),a._updateChildren(),a=!0;return a}var e=function(a){if(a._animation=void 0,a instanceof
window.SequenceEffect||a instanceof window.GroupEffect)for(var b=0;b<a.children.length;b++)e(a.children[b])};b.removeMulti=function(a){for(var b=[],c=0;c<a.length;c++){var d=a[c];d._parent?(-1==b.indexOf(d._parent)&&b.push(d._parent),d._parent.children.splice(d._parent.children.indexOf(d),1),d._parent=null,e(d)):d._animation&&d._animation.effect==d&&(d._animation.cancel(),d._animation.effect=new KeyframeEffect(null,[]),d._animation._callback&&(d._animation._callback._animation=null),d._animation._rebuildUnderlyingAnimation(),
e(d))}for(c=0;c<b.length;c++)b[c]._rebuild()};b.KeyframeEffect=function(b,d,e,f){return this.target=b,this._parent=null,e=a.numericTimingToObject(e),this._timingInput=a.cloneTimingInput(e),this._timing=a.normalizeTimingInput(e),this.timing=a.makeTiming(e,!1,this),this.timing._effect=this,"function"==typeof d?(a.deprecated("Custom KeyframeEffect","2015-06-22","Use KeyframeEffect.onsample instead."),this._normalizedKeyframes=d):this._normalizedKeyframes=new c(d),this._keyframes=d,this.activeDuration=
a.calculateActiveDuration(this._timing),this._id=f,this};b.KeyframeEffect.prototype={getFrames:function(){return"function"==typeof this._normalizedKeyframes?this._normalizedKeyframes:this._normalizedKeyframes._frames},set onsample(a){if("function"==typeof this.getFrames())throw Error("Setting onsample on custom effect KeyframeEffect is not supported.");this._onsample=a;this._animation&&this._animation._rebuildUnderlyingAnimation()},get parent(){return this._parent},clone:function(){if("function"==
typeof this.getFrames())throw Error("Cloning custom effects is not supported.");var b=new KeyframeEffect(this.target,[],a.cloneTimingInput(this._timingInput),this._id);return b._normalizedKeyframes=this._normalizedKeyframes,b._keyframes=this._keyframes,b},remove:function(){b.removeMulti([this])}};var f=Element.prototype.animate;Element.prototype.animate=function(a,c){var d="";return c&&c.id&&(d=c.id),b.timeline._play(new b.KeyframeEffect(this,a,c,d))};var l=document.createElementNS("http://www.w3.org/1999/xhtml",
"div");b.newUnderlyingAnimationForKeyframeEffect=function(a){if(a){var b=a.target||l,c=a._keyframes;"function"==typeof c&&(c=[]);var d=a._timingInput;d.id=a._id}else b=l,c=[],d=0;return f.apply(b,[c,d])};b.bindAnimationForKeyframeEffect=function(a){a.effect&&"function"==typeof a.effect._normalizedKeyframes&&b.bindAnimationForCustomEffect(a)};var v=[];b.awaitStartTime=function(a){null===a.startTime&&a._isGroup&&(0==v.length&&requestAnimationFrame(d),v.push(a))};var z=window.getComputedStyle;Object.defineProperty(window,
"getComputedStyle",{configurable:!0,enumerable:!0,value:function(){window.document.timeline._updateAnimationsPromises();var a=z.apply(this,arguments);return d()&&(a=z.apply(this,arguments)),window.document.timeline._updateAnimationsPromises(),a}});window.KeyframeEffect=b.KeyframeEffect;window.Element.prototype.getAnimations=function(){return document.timeline.getAnimations().filter(function(a){return null!==a.effect&&a.effect.target==this}.bind(this))}})(c,e,null);(function(a,b){function c(a){a._registered||
(a._registered=!0,f.push(a),l||(l=!0,requestAnimationFrame(d)))}function d(){var a=f;f=[];a.sort(function(a,b){return a._sequenceNumber-b._sequenceNumber});a=a.filter(function(a){a();var b=a._animation?a._animation.playState:"idle";return"running"!=b&&"pending"!=b&&(a._registered=!1),a._registered});f.push.apply(f,a);f.length?(l=!0,requestAnimationFrame(d)):l=!1}var e=(document.createElementNS("http://www.w3.org/1999/xhtml","div"),0);b.bindAnimationForCustomEffect=function(b){var d=b.effect.target,
f="function"==typeof b.effect.getFrames();var h=f?b.effect.getFrames():b.effect._onsample;var m=b.effect.timing,l=null;m=a.normalizeTimingInput(m);var k=function(){var c=k._animation?k._animation.currentTime:null;null!==c&&(c=a.calculateTimeFraction(a.calculateActiveDuration(m),c,m),isNaN(c)&&(c=null));c!==l&&(f?h(c,d,b.effect):h(c,b.effect,b.effect._animation));l=c};k._animation=b;k._registered=!1;k._sequenceNumber=e++;b._callback=k;c(k)};var f=[],l=!1;b.Animation.prototype._register=function(){this._callback&&
c(this._callback)}})(c,e,null);(function(a,b){function c(a){return a._timing.delay+a.activeDuration+a._timing.endDelay}function d(b,c,d){this._id=d;this._parent=null;this.children=b||[];this._reparent(this.children);c=a.numericTimingToObject(c);this._timingInput=a.cloneTimingInput(c);this._timing=a.normalizeTimingInput(c,!0);this.timing=a.makeTiming(c,!0,this);this.timing._effect=this;"auto"===this._timing.duration&&(this._timing.duration=this.activeDuration)}window.SequenceEffect=function(){d.apply(this,
arguments)};window.GroupEffect=function(){d.apply(this,arguments)};d.prototype={_isAncestor:function(a){for(var b=this;null!==b;){if(b==a)return!0;b=b._parent}return!1},_rebuild:function(){for(var a=this;a;)"auto"===a.timing.duration&&(a._timing.duration=a.activeDuration),a=a._parent;this._animation&&this._animation._rebuildUnderlyingAnimation()},_reparent:function(a){b.removeMulti(a);for(var c=0;c<a.length;c++)a[c]._parent=this},_putChild:function(a,b){for(var c=b?"Cannot append an ancestor or self":
"Cannot prepend an ancestor or self",d=0;d<a.length;d++)if(this._isAncestor(a[d]))throw{type:DOMException.HIERARCHY_REQUEST_ERR,name:"HierarchyRequestError",message:c};for(d=0;d<a.length;d++)b?this.children.push(a[d]):this.children.unshift(a[d]);this._reparent(a);this._rebuild()},append:function(){this._putChild(arguments,!0)},get parent(){return this._parent},get firstChild(){return this.children.length?this.children[0]:null},get lastChild(){return this.children.length?this.children[this.children.length-
1]:null},clone:function(){for(var b=a.cloneTimingInput(this._timingInput),c=[],d=0;d<this.children.length;d++)c.push(this.children[d].clone());return this instanceof GroupEffect?new GroupEffect(c,b):new SequenceEffect(c,b)},remove:function(){b.removeMulti([this])}};window.SequenceEffect.prototype=Object.create(d.prototype);Object.defineProperty(window.SequenceEffect.prototype,"activeDuration",{get:function(){var a=0;return this.children.forEach(function(b){a+=c(b)}),Math.max(a,0)}});window.GroupEffect.prototype=
Object.create(d.prototype);Object.defineProperty(window.GroupEffect.prototype,"activeDuration",{get:function(){var a=0;return this.children.forEach(function(b){a=Math.max(a,c(b))}),a}});b.newUnderlyingAnimationForGroup=function(c){var d,e=null,f=function(b){var c=d._wrapper;return c&&"pending"!=c.playState&&c.effect?null==b?void c._removeChildAnimations():0==b&&0>c.playbackRate&&(e||(e=a.normalizeTimingInput(c.effect.timing)),b=a.calculateTimeFraction(a.calculateActiveDuration(e),-1,e),isNaN(b)||
null==b)?(c._forEachChild(function(a){a.currentTime=-1}),void c._removeChildAnimations()):void 0:void 0};c=new KeyframeEffect(null,[],c._timing,c._id);return c.onsample=f,d=b.timeline._play(c)};b.bindAnimationForGroup=function(a){a._animation._wrapper=a;a._isGroup=!0;b.awaitStartTime(a);a._constructChildAnimations();a._setExternalAnimation(a)};b.groupChildDuration=c})(c,e,null);b["true"]=a}({},function(){return this}())})();D.NeonAnimation.Animations={};D.NeonAnimation.Animations.FadeInAnimation={};Polymer({is:"fade-in-animation",behaviors:[Polymer.NeonAnimationBehavior],configure:function(a){var b=a.node;return this._effect=new KeyframeEffect(b,[{opacity:"0"},{opacity:"1"}],this.timingFromConfig(a))}});D.NeonAnimation.Animations.FadeOutAnimation={};Polymer({is:"fade-out-animation",behaviors:[Polymer.NeonAnimationBehavior],configure:function(a){var b=a.node;return this._effect=new KeyframeEffect(b,[{opacity:"1"},{opacity:"0"}],this.timingFromConfig(a))}});D.NeonAnimation.Animations.OpaqueAnimation={};Polymer({is:"opaque-animation",behaviors:[Polymer.NeonAnimationBehavior],configure:function(a){var b=a.node;b.style.opacity="0";return this._effect=new KeyframeEffect(b,[{opacity:"1"},{opacity:"1"}],this.timingFromConfig(a))},complete:function(a){a.node.style.opacity=""}});D.NeonAnimation.NeonAnimatableBehavior={};
...
else{var d=a?this.animationConfig[a]:this.animationConfig;Array.isArray(d)||(d=[d]);if(d)for(var e,f=0;e=d[f];f++)if(e.animatable)e.animatable._getAnimationConfigRecursive(e.type||a,b,c);else if(e.id){var l=b[e.id];l?(l.isClone||(b[e.id]=this._cloneConfig(l),l=b[e.id]),this._copyProperties(l,e)):b[e.id]=e}else c.push(e)}},getAnimationConfig:function(a){var b={},c=[];this._getAnimationConfigRecursive(a,b,c);for(var d in b)c.push(b[d]);return c}};D.NeonAnimation.NeonAnimationRunnerBehavior={};
...
Polymer.NeonAnimationRunnerBehavior=[Polymer.NeonAnimatableBehavior,Polymer.NeonAnimationRunnerBehaviorImpl];D.PaperTooltip={};D.PaperTooltip.PaperTooltip={};
Polymer({is:"paper-tooltip",hostAttributes:{role:"tooltip",tabindex:-1},behaviors:[Polymer.NeonAnimationRunnerBehavior],properties:{for:{type:String,observer:"_findTarget"},manualMode:{type:Boolean,value:!1,observer:"_manualModeChanged"},position:{type:String,value:"bottom"},fitToVisibleBounds:{type:Boolean,value:!1},offset:{type:Number,value:14},marginTop:{type:Number,value:14},animationDelay:{type:Number,value:500},animationConfig:{type:Object,value:function(){return{entry:[{name:"fade-in-animation",node:this,
timing:{delay:0}}],exit:[{name:"fade-out-animation",node:this}]}}},_showing:{type:Boolean,value:!1}},listeners:{"neon-animation-finish":"_onAnimationFinish"},get target(){var a=Polymer.dom(this).parentNode,b=Polymer.dom(this).getOwnerRoot();return a=this.for?Polymer.dom(b).querySelector("#"+this.for):a.nodeType==Node.DOCUMENT_FRAGMENT_NODE?b.host:a},attached:function(){this._findTarget()},detached:function(){this.manualMode||this._removeListeners()},show:function(){if(!this._showing){if(""===Polymer.dom(this).textContent.trim()){for(var a=
!0,b=Polymer.dom(this).getEffectiveChildNodes(),c=0;c<b.length;c++)if(""!==b[c].textContent.trim()){a=!1;break}if(a)return}this.cancelAnimation();this._showing=!0;this.toggleClass("hidden",!1,this.$.tooltip);this.updatePosition();this.animationConfig.entry[0].timing=this.animationConfig.entry[0].timing||{};this.animationConfig.entry[0].timing.delay=this.animationDelay;this._animationPlaying=!0;this.playAnimation("entry")}},hide:function(){this._showing&&(this._animationPlaying?(this.cancelAnimation(),
this._showing=!1,this._onAnimationFinish()):(this._showing=!1,this._animationPlaying=!0,this.playAnimation("exit")))},updatePosition:function(){if(this._target&&this.offsetParent){var a=this.offset;14!=this.marginTop&&14==this.offset&&(a=this.marginTop);var b=this.offsetParent.getBoundingClientRect(),c=this._target.getBoundingClientRect(),d=this.getBoundingClientRect(),e=(c.width-d.width)/2,f=(c.height-d.height)/2,l=c.left-b.left,h=c.top-b.top;switch(this.position){case "top":var k=l+e;var m=h-d.height-
a;break;case "bottom":k=l+e;m=h+c.height+a;break;case "left":k=l-d.width-a;m=h+f;break;case "right":k=l+c.width+a,m=h+f}this.fitToVisibleBounds?(b.left+k+d.width>window.innerWidth?(this.style.right="0px",this.style.left="auto"):(this.style.left=Math.max(0,k)+"px",this.style.right="auto"),b.top+m+d.height>window.innerHeight?(this.style.bottom=b.height+"px",this.style.top="auto"):(this.style.top=Math.max(-b.top,m)+"px",this.style.bottom="auto")):(this.style.left=k+"px",this.style.top=m+"px")}},_addListeners:function(){this._target&&
(this.listen(this._target,"mouseenter","show"),this.listen(this._target,"focus","show"),this.listen(this._target,"mouseleave","hide"),this.listen(this._target,"blur","hide"),this.listen(this._target,"tap","hide"));this.listen(this,"mouseenter","hide")},_findTarget:function(){this.manualMode||this._removeListeners();this._target=this.target;this.manualMode||this._addListeners()},_manualModeChanged:function(){this.manualMode?this._removeListeners():this._addListeners()},_onAnimationFinish:function(){this._animationPlaying=
!1;this._showing||this.toggleClass("hidden",!0,this.$.tooltip)},_removeListeners:function(){this._target&&(this.unlisten(this._target,"mouseenter","show"),this.unlisten(this._target,"focus","show"),this.unlisten(this._target,"mouseleave","hide"),this.unlisten(this._target,"blur","hide"),this.unlisten(this._target,"tap","hide"));this.unlisten(this,"mouseenter","hide")}});D.IronJsonpLibrary={};D.IronJsonpLibrary.IronJsonpLibrary={};
(function(){Polymer.IronJsonpLibraryBehavior={properties:{libraryLoaded:{type:Boolean,value:!1,notify:!0,readOnly:!0},libraryErrorMessage:{type:String,value:null,notify:!0,readOnly:!0}},observers:["_libraryUrlChanged(libraryUrl)"],_libraryUrlChanged:function(){this._isReady&&this.libraryUrl&&this._loadLibrary()},_libraryLoadCallback:function(a,b){a?(Polymer.Base._warn("Library load failed:",a.message),this._setLibraryErrorMessage(a.message)):(this._setLibraryErrorMessage(null),this._setLibraryLoaded(!0),
this.notifyEvent&&this.fire(this.notifyEvent,b,{composed:!0}))},_loadLibrary:function(){a.require(this.libraryUrl,this._libraryLoadCallback.bind(this),this.callbackName)},ready:function(){this._isReady=!0;this.libraryUrl&&this._loadLibrary()}};var a={apiMap:{},require:function(a,d,e){var c=this.nameFromUrl(a);this.apiMap[c]||(this.apiMap[c]=new b(c,a,e));this.apiMap[c].requestNotify(d)},nameFromUrl:function(a){return a.replace(/[:\/%\?&\.=\-,]/g,"_")+"_api"}},b=function(a,b,e){this.notifiers=[];if(!e)if(0<=
b.indexOf(this.callbackMacro))e=a+"_loaded",b=b.replace(this.callbackMacro,e);else{this.error=Error("IronJsonpLibraryBehavior a %%callback%% parameter is required in libraryUrl");return}this.callbackName=e;window[this.callbackName]=this.success.bind(this);this.addScript(b)};b.prototype={callbackMacro:"%%callback%%",loaded:!1,addScript:function(a){var b=document.createElement("script");b.src=a;b.onerror=this.handleError.bind(this);a=document.querySelector("script")||document.body;a.parentNode.insertBefore(b,
a)},handleError:function(){this.error=Error("Library failed to load");this.notifyAll();this.cleanup()},success:function(){this.loaded=!0;this.result=Array.prototype.slice.call(arguments);this.notifyAll();this.cleanup()},cleanup:function(){delete window[this.callbackName]},notifyAll:function(){this.notifiers.forEach(function(a){a(this.error,this.result)}.bind(this));this.notifiers=[]},requestNotify:function(a){this.loaded||this.error?a(this.error,this.result):this.notifiers.push(a)}}})();
Polymer({is:"iron-jsonp-library",behaviors:[Polymer.IronJsonpLibraryBehavior],properties:{libraryUrl:String,callbackName:String,notifyEvent:String}});D.GoogleApis={};D.GoogleApis.GoogleMapsApi={};
Polymer({is:"google-maps-api",behaviors:[Polymer.IronJsonpLibraryBehavior],properties:{mapsUrl:{type:String,value:"https://maps.googleapis.com/maps/api/js?callback=%%callback%%"},apiKey:{type:String,value:""},clientId:{type:String,value:""},version:{type:String,value:"3.exp"},language:{type:String,value:""},signedIn:{type:Boolean,value:!1},notifyEvent:{type:String,value:"api-load"},libraryUrl:{type:String,computed:"_computeUrl(mapsUrl, version, apiKey, clientId, language, signedIn)"}},_computeUrl:function(a,
b,c,d,e,f){a=a+"&v="+b;a+="&libraries=drawing,geometry,places,visualization";c&&!d&&(a+="&key="+c);d&&(a+="&client="+d);c||d||console.warn("No Google Maps API Key or Client ID specified. See https://developers.google.com/maps/documentation/javascript/get-api-key for instructions to get started with a key or client id.");e&&(a+="&language="+e);f&&(a+="&signed_in="+f);return a},get api(){return google.maps}});D.GoogleMap={};D.GoogleMap.GoogleMapDirections={};
Polymer({is:"google-map-directions",properties:{apiKey:String,mapsUrl:{type:String},map:{type:Object,observer:"_mapChanged"},startAddress:{type:String,value:null},endAddress:{type:String,value:null},travelMode:{type:String,value:"DRIVING"},waypoints:{type:Array,value:function(){return[]}},language:{type:String,value:null},rendererOptions:{type:Object,value:function(){return{}}},response:{type:Object,observer:"_responseChanged",notify:!0}},observers:["_route(startAddress, endAddress, travelMode, waypoints.*)"],_mapApiLoaded:function(){this._route()},
_responseChanged:function(){this.directionsRenderer&&this.response&&this.directionsRenderer.setDirections(this.response)},_mapChanged:function(){this.map&&this.map instanceof google.maps.Map?(this.directionsRenderer||(this.directionsRenderer=new google.maps.DirectionsRenderer(this.rendererOptions)),this.directionsRenderer.setMap(this.map),this._responseChanged()):this.directionsRenderer&&(this.directionsRenderer.setMap(null),this.directionsRenderer=null)},_route:function(){if("undefined"!=typeof google&&
"undefined"!=typeof google.maps&&this.startAddress&&this.endAddress){this.directionsService||(this.directionsService=new google.maps.DirectionsService);var a={origin:this.startAddress,destination:this.endAddress,travelMode:this.travelMode,waypoints:this.waypoints};this.directionsService.route(a,function(a,c){c==google.maps.DirectionsStatus.OK&&(this.response=a,this.fire("google-map-response",{response:a}))}.bind(this))}}});D.GoogleMap.GoogleMapMarker={};
(function(){function a(){this.draggable?this.dragHandler_=google.maps.event.addListener(this.marker,"dragend",b.bind(this)):(google.maps.event.removeListener(this.dragHandler_),this.dragHandler_=null)}function b(a){this.latitude=a.latLng.lat();this.longitude=a.latLng.lng()}Polymer({is:"google-map-marker",properties:{marker:{type:Object,notify:!0},map:{type:Object,observer:"_mapChanged"},info:{type:Object,value:null},clickEvents:{type:Boolean,value:!1,observer:"_clickEventsChanged"},dragEvents:{type:Boolean,
value:!1,observer:"_dragEventsChanged"},icon:{type:Object,value:null,observer:"_iconChanged"},mouseEvents:{type:Boolean,value:!1,observer:"_mouseEventsChanged"},zIndex:{type:Number,value:0,observer:"_zIndexChanged"},longitude:{type:Number,value:null,notify:!0},latitude:{type:Number,value:null,notify:!0},animation:{type:String,value:null,observer:"_animationChanged"},open:{type:Boolean,value:!1,observer:"_openChanged"}},observers:["_updatePosition(latitude, longitude)"],detached:function(){this.marker&&
(google.maps.event.clearInstanceListeners(this.marker),this._listeners={},this.marker.setMap(null));this._contentObserver&&this._contentObserver.disconnect()},attached:function(){this.marker&&this.marker.setMap(this.map)},_updatePosition:function(){this.marker&&null!=this.latitude&&null!=this.longitude&&this.marker.setPosition(new google.maps.LatLng(parseFloat(this.latitude),parseFloat(this.longitude)))},_clickEventsChanged:function(){this.map&&(this.clickEvents?(this._forwardEvent("click"),this._forwardEvent("dblclick"),
this._forwardEvent("rightclick")):(this._clearListener("click"),this._clearListener("dblclick"),this._clearListener("rightclick")))},_dragEventsChanged:function(){this.map&&(this.dragEvents?(this._forwardEvent("drag"),this._forwardEvent("dragend"),this._forwardEvent("dragstart")):(this._clearListener("drag"),this._clearListener("dragend"),this._clearListener("dragstart")))},_mouseEventsChanged:function(){this.map&&(this.mouseEvents?(this._forwardEvent("mousedown"),this._forwardEvent("mousemove"),
this._forwardEvent("mouseout"),this._forwardEvent("mouseover"),this._forwardEvent("mouseup")):(this._clearListener("mousedown"),this._clearListener("mousemove"),this._clearListener("mouseout"),this._clearListener("mouseover"),this._clearListener("mouseup")))},_animationChanged:function(){this.marker&&this.marker.setAnimation(google.maps.Animation[this.animation])},_iconChanged:function(){this.marker&&this.marker.setIcon(this.icon)},_zIndexChanged:function(){this.marker&&this.marker.setZIndex(this.zIndex)},
_mapChanged:function(){this.marker&&(this.marker.setMap(null),google.maps.event.clearInstanceListeners(this.marker));this.map&&this.map instanceof google.maps.Map&&this._mapReady()},_contentChanged:function(){this._contentObserver&&this._contentObserver.disconnect();this._contentObserver=new MutationObserver(this._contentChanged.bind(this));this._contentObserver.observe(this,{childList:!0,subtree:!0});var a=this.innerHTML.trim();a?(this.info||(this.info=new google.maps.InfoWindow,this.openInfoHandler_=
google.maps.event.addListener(this.marker,"click",function(){this.open=!0}.bind(this)),this.closeInfoHandler_=google.maps.event.addListener(this.info,"closeclick",function(){this.open=!1}.bind(this))),this.info.setContent(a)):this.info&&(google.maps.event.removeListener(this.openInfoHandler_),google.maps.event.removeListener(this.closeInfoHandler_),this.info=null)},_openChanged:function(){this.info&&(this.open?(this.info.open(this.map,this.marker),this.fire("google-map-marker-open")):(this.info.close(),
this.fire("google-map-marker-close")))},_mapReady:function(){this._listeners={};this.marker=new google.maps.Marker({map:this.map,position:{lat:parseFloat(this.latitude),lng:parseFloat(this.longitude)},title:this.title,animation:google.maps.Animation[this.animation],draggable:this.draggable,visible:!this.hidden,icon:this.icon,zIndex:this.zIndex});this._contentChanged();this._clickEventsChanged();this._dragEventsChanged();this._mouseEventsChanged();this._openChanged();a.bind(this)()},_clearListener:function(a){this._listeners[a]&&
(google.maps.event.removeListener(this._listeners[a]),this._listeners[a]=null)},_forwardEvent:function(a){this._listeners[a]=google.maps.event.addListener(this.marker,a,function(b){this.fire("google-map-marker-"+a,b)}.bind(this))},attributeChanged:function(b){if(this.marker)switch(b){case "hidden":this.marker.setVisible(!this.hidden);break;case "draggable":this.marker.setDraggable(this.draggable);a.bind(this)();break;case "title":this.marker.setTitle(this.title)}}})})();D.IronSelector.IronSelector={};Polymer({is:"iron-selector",behaviors:[Polymer.IronMultiSelectableBehavior]});D.GoogleMap.GoogleMap={};
Polymer({is:"google-map",properties:{apiKey:String,mapsUrl:{type:String},clientId:String,latitude:{type:Number,value:37.77493,notify:!0,reflectToAttribute:!0},map:{type:Object,notify:!0,value:null},longitude:{type:Number,value:-122.41942,notify:!0,reflectToAttribute:!0},kml:{type:String,value:null,observer:"_loadKml"},zoom:{type:Number,value:10,observer:"_zoomChanged",notify:!0},noAutoTilt:{type:Boolean,value:!1},mapType:{type:String,value:"roadmap",observer:"_mapTypeChanged",notify:!0},version:{type:String,
value:"3.exp"},disableDefaultUi:{type:Boolean,value:!1,observer:"_disableDefaultUiChanged"},disableMapTypeControl:{type:Boolean,value:!1,observer:"_disableMapTypeControlChanged"},disableStreetViewControl:{type:Boolean,value:!1,observer:"_disableStreetViewControlChanged"},fitToMarkers:{type:Boolean,value:!1,observer:"_fitToMarkersChanged"},disableZoom:{type:Boolean,value:!1,observer:"_disableZoomChanged"},styles:{type:Object,value:function(){return{}}},maxZoom:{type:Number,observer:"_maxZoomChanged"},
minZoom:{type:Number,observer:"_minZoomChanged"},signedIn:{type:Boolean,value:!1},language:{type:String},clickEvents:{type:Boolean,value:!1,observer:"_clickEventsChanged"},dragEvents:{type:Boolean,value:!1,observer:"_dragEventsChanged"},mouseEvents:{type:Boolean,value:!1,observer:"_mouseEventsChanged"},additionalMapOptions:{type:Object,value:function(){return{}}},markers:{type:Array,value:function(){return[]},readOnly:!0},objects:{type:Array,value:function(){return[]},readOnly:!0},singleInfoWindow:{type:Boolean,
value:!1}},behaviors:[Polymer.IronResizableBehavior],listeners:{"iron-resize":"resize"},observers:["_debounceUpdateCenter(latitude, longitude)"],attached:function(){this._initGMap()},detached:function(){this._markersChildrenListener&&(this.unlisten(this.$.selector,"items-changed","_updateMarkers"),this._markersChildrenListener=null);this._objectsMutationObserver&&(this._objectsMutationObserver.disconnect(),this._objectsMutationObserver=null)},_initGMap:function(){!this.map&&!0===this.$.api.libraryLoaded&&
...
!this.disableStreetViewControl,disableDoubleClickZoom:this.disableZoom,scrollwheel:!this.disableZoom,styles:this.styles,maxZoom:Number(this.maxZoom),minZoom:Number(this.minZoom)};null!=this.getAttribute("draggable")&&(a.draggable=this.draggable);for(var b in this.additionalMapOptions)a[b]=this.additionalMapOptions[b];return a},_attachChildrenToMap:function(a){if(this.map)for(var b=0,c;c=a[b];++b)c.map=this.map},_observeMarkers:function(){this._markersChildrenListener||(this._markersChildrenListener=
this.listen(this.$.selector,"items-changed","_updateMarkers"))},_updateMarkers:function(){var a=Array.prototype.slice.call(Polymer.dom(this.$.markers).getDistributedNodes());if(a.length===this.markers.length){var b=a.filter(function(a){return this.markers&&-1===this.markers.indexOf(a)}.bind(this));if(0===b.length){this._markersChildrenListener||this._observeMarkers();return}}this._observeMarkers();this.markers=this._setMarkers(a);this._attachChildrenToMap(this.markers);this.fitToMarkers&&this._fitToMarkersChanged()},
_observeObjects:function(){this._objectsMutationObserver||(this._objectsMutationObserver=new MutationObserver(this._updateObjects.bind(this)),this._objectsMutationObserver.observe(this,{childList:!0}))},_updateObjects:function(){var a=Array.prototype.slice.call(Polymer.dom(this.$.objects).getDistributedNodes());if(a.length===this.objects.length){var b=a.filter(function(a){return-1===this.objects.indexOf(a)}.bind(this));if(0===b.length){this._observeObjects();return}}this._observeObjects();this._setObjects(a);
this._attachChildrenToMap(this.objects)},clear:function(){for(var a=0,b;b=this.markers[a];++a)b.marker.setMap(null)},resize:function(){if(this.map){var a=this.latitude,b=this.longitude;google.maps.event.trigger(this.map,"resize");this.latitude=a;this.longitude=b;this.fitToMarkers&&this._fitToMarkersChanged()}},_loadKml:function(){this.map&&this.kml&&new google.maps.KmlLayer({url:this.kml,map:this.map})},_debounceUpdateCenter:function(){this.debounce("updateCenter",this._updateCenter)},_updateCenter:function(){this.cancelDebouncer("updateCenter");
if(this.map&&void 0!==this.latitude&&void 0!==this.longitude){var a=Number(this.latitude);if(isNaN(a))throw new TypeError("latitude must be a number");var b=Number(this.longitude);if(isNaN(b))throw new TypeError("longitude must be a number");a=new google.maps.LatLng(a,b);(b=this.map.getCenter())?(b=new google.maps.LatLng(b.lat(),b.lng()),b.equals(a)||this.map.panTo(a)):this.map.setCenter(a)}},_zoomChanged:function(){this.map&&this.map.setZoom(Number(this.zoom))},_idleEvent:function(){this.map?this._forwardEvent("idle"):
this._clearListener("idle")},_clickEventsChanged:function(){this.map&&(this.clickEvents?(this._forwardEvent("click"),this._forwardEvent("dblclick"),this._forwardEvent("rightclick")):(this._clearListener("click"),this._clearListener("dblclick"),this._clearListener("rightclick")))},_dragEventsChanged:function(){this.map&&(this.dragEvents?(this._forwardEvent("drag"),this._forwardEvent("dragend"),this._forwardEvent("dragstart")):(this._clearListener("drag"),this._clearListener("dragend"),this._clearListener("dragstart")))},
_mouseEventsChanged:function(){this.map&&(this.mouseEvents?(this._forwardEvent("mousemove"),this._forwardEvent("mouseout"),this._forwardEvent("mouseover")):(this._clearListener("mousemove"),this._clearListener("mouseout"),this._clearListener("mouseover")))},_maxZoomChanged:function(){this.map&&this.map.setOptions({maxZoom:Number(this.maxZoom)})},_minZoomChanged:function(){this.map&&this.map.setOptions({minZoom:Number(this.minZoom)})},_mapTypeChanged:function(){this.map&&this.map.setMapTypeId(this.mapType)},
_disableDefaultUiChanged:function(){this.map&&this.map.setOptions({disableDefaultUI:this.disableDefaultUi})},_disableMapTypeControlChanged:function(){this.map&&this.map.setOptions({mapTypeControl:!this.disableMapTypeControl})},_disableStreetViewControlChanged:function(){this.map&&this.map.setOptions({streetViewControl:!this.disableStreetViewControl})},_disableZoomChanged:function(){this.map&&this.map.setOptions({disableDoubleClickZoom:this.disableZoom,scrollwheel:!this.disableZoom})},attributeChanged:function(a){if(this.map)switch(a){case "draggable":this.map.setOptions({draggable:this.draggable})}},
_fitToMarkersChanged:function(){if(this.map&&this.fitToMarkers&&0<this.markers.length){for(var a=new google.maps.LatLngBounds,b=0,c;c=this.markers[b];++b)a.extend(new google.maps.LatLng(c.latitude,c.longitude));1<this.markers.length&&this.map.fitBounds(a);this.map.setCenter(a.getCenter())}},_addMapListeners:function(){google.maps.event.addListener(this.map,"center_changed",function(){var a=this.map.getCenter();this.latitude=a.lat();this.longitude=a.lng()}.bind(this));google.maps.event.addListener(this.map,
...
a,b)}.bind(this))},_deselectMarker:function(a){var b=this.$.selector.indexOf(a.target);this.singleInfoWindow?this.$.selector.selected=null:this.$.selector.selectedValues&&(this.$.selector.selectedValues=this.$.selector.selectedValues.filter(function(a){return a!==b}))}});D.GoogleMap.GoogleMapPoint={};Polymer({is:"google-map-point",hostAttributes:{hidden:!0},properties:{longitude:{type:Number,value:null},latitude:{type:Number,value:null}},getPosition:function(){return new google.maps.LatLng(this.latitude,this.longitude)}});D.GoogleMap.GoogleMapPoly={};
Polymer({is:"google-map-poly",properties:{poly:{type:Object,readOnly:!0},path:{type:Object,readOnly:!0},map:{type:Object,observer:"_mapChanged"},clickable:{type:Boolean,value:!1,observer:"_clickableChanged"},clickEvents:{type:Boolean,value:!1,observer:"_clickEventsChanged"},closed:{type:Boolean,value:!1,observer:"_closedChanged"},draggable:{type:Boolean,value:!1},dragEvents:{type:Boolean,value:!1,observer:"_dragEventsChanged"},editable:{type:Boolean,value:!1,observer:"_editableChanged"},editing:{type:Boolean,
value:!1,notify:!0,readOnly:!0},fillColor:{type:String,value:"",observer:"_fillColorChanged"},fillOpacity:{type:Number,value:0,observer:"_fillOpacityChanged"},geodesic:{type:Boolean,value:!1,observer:"_geodesicChanged"},icons:{type:Array,value:null,observer:"_iconsChanged"},mouseEvents:{type:Boolean,value:!1,observer:"_mouseEventsChanged"},strokeColor:{type:String,value:"black",observer:"_strokeColorChanged"},strokeOpacity:{type:Number,value:1,observer:"_strokeOpacityChanged"},strokePosition:{type:String,
value:"center",observer:"_strokePositionChanged"},strokeWeight:{type:Number,value:3,observer:"_strokeWeightChanged"},zIndex:{type:Number,value:0,observer:"_zIndexChanged"}},detached:function(){this.poly.setMap(null);this._pointsObserver&&(this._pointsObserver.disconnect(),this._pointsObserver=null);for(var a in this._listeners)this._clearListener(a)},attached:function(){this.poly&&this.poly.setMap(this.map)},attributeChanged:function(a){if(this.poly)switch(a){case "hidden":this.poly.setVisible(!this.hidden);
break;case "draggable":this.poly.setDraggable(this.draggable)}},_clickableChanged:function(){this.poly&&this.poly.set("clickable",this.clickable)},_clickEventsChanged:function(){this.poly&&(this.clickEvents?(this._forwardEvent("click"),this._forwardEvent("dblclick"),this._forwardEvent("rightclick")):(this._clearListener("click"),this._clearListener("dblclick"),this._clearListener("rightclick")))},_closedChanged:function(){this._mapChanged()},_dragEventsChanged:function(){this.poly&&(this.clickEvents?
(this._forwardEvent("drag"),this._forwardEvent("dragend"),this._forwardEvent("dragstart")):(this._clearListener("drag"),this._clearListener("dragend"),this._clearListener("dragstart")))},_editableChanged:function(){this.poly&&this.poly.setEditable(this.editable)},_fillColorChanged:function(){this.poly&&this.poly.set("fillColor",this.fillColor)},_fillOpacityChanged:function(){this.poly&&this.poly.set("fillOpacity",this.fillOpacity)},_geodesicChanged:function(){this.poly&&this.poly.set("geodesic",this.geodesic)},
...
this._clearListener("mousemove"),this._clearListener("mouseout"),this._clearListener("mouseover"),this._clearListener("mouseup")))},_strokeColorChanged:function(){this.poly&&this.poly.set("strokeColor",this.strokeColor)},_strokeOpacityChanged:function(){this.poly&&this.poly.set("strokeOpacity",this.strokeOpacity)},_strokePositionChanged:function(){this.poly&&this.poly.set("strokePosition",this._convertStrokePosition())},_strokeWeightChanged:function(){this.poly&&this.poly.set("strokeWeight",this.strokeWeight)},
_zIndexChanged:function(){this.poly&&this.poly.set("zIndex",this.zIndex)},_buildPathFromPoints:function(){this._points=Array.prototype.slice.call(Polymer.dom(this.$.points).getDistributedNodes());this._building=!0;this.path.clear();for(var a=0,b;b=this._points[a];++a)this.path.push(b.getPosition());this._building=!1;this.fire("google-map-poly-path-built",this.path);this._pointsObserver||(this._pointsObserver=new MutationObserver(this._buildPathFromPoints.bind(this)),this._pointsObserver.observe(this,
{childList:!0}))},_clearListener:function(a){this._listeners[a]&&(google.maps.event.removeListener(this._listeners[a]),this._listeners[a]=null)},_convertStrokePosition:function(){return google.maps.StrokePosition&&this.strokePosition?google.maps.StrokePosition[this.strokePosition.toUpperCase()]:0},_createPoly:function(){this.path||(this._setPath(new google.maps.MVCArray),google.maps.event.addListener(this.path,"insert_at",this._startEditing.bind(this)),google.maps.event.addListener(this.path,"set_at",
this._updatePoint.bind(this)),this._buildPathFromPoints());var a={clickable:this.clickable||this.draggable,draggable:this.draggable,editable:this.editable,geodesic:this.geodesic,map:this.map,path:this.path,strokeColor:this.strokeColor,strokeOpacity:this.strokeOpacity,strokePosition:this._convertStrokePosition(),strokeWeight:this.strokeWeight,visible:!this.hidden,zIndex:this.zIndex};this.closed?(a.fillColor=this.fillColor,a.fillOpacity=this.fillOpacity,this._setPoly(new google.maps.Polygon(a))):(a.icons=
this.icons,this._setPoly(new google.maps.Polyline(a)));this._listeners={};this._clickEventsChanged();this._mouseEventsChanged();this._dragEventsChanged()},_forwardEvent:function(a){this._listeners[a]=google.maps.event.addListener(this.poly,a,function(b){this.fire("google-map-poly-"+a,b)}.bind(this))},_startEditing:function(){this._building||this.editing||(this._setEditing(!0),this._points=null,google.maps.event.addListenerOnce(this.map,"click",function(){this._setEditing(!1);this.fire("google-map-poly-path-updated",
this.path)}.bind(this)))},_updatePoint:function(a,b){this._points&&(this._points[a].latitude=b.lat(),this._points[a].longitude=b.lng())}});D.GoogleMap.GoogleMapSearch={};
Polymer({is:"google-map-search",properties:{map:{type:Object,value:null},query:{type:String,value:null},latitude:{type:Number,value:null},longitude:{type:Number,value:null},radius:{type:Number,value:null},globalSearch:{type:Boolean,value:!1},types:{type:String,value:null},results:{type:Array,value:function(){return[]},notify:!0},location:{type:Object,value:null,readOnly:!0}},observers:["search(query,map,location,radius,types,globalSearch)","_updateLocation(latitude,longitude)"],search:function(){if(this.query&&
...
function(a,b){b===google.maps.places.PlacesServiceStatus.OK?(c(a),this.fire("google-map-search-place-detail",a)):d(b)}.bind(this))}.bind(this))},_gotResults:function(a){this.results=a.map(function(a){a.latitude=a.geometry.location.lat();a.longitude=a.geometry.location.lng();return a});this.fire("google-map-search-results",this.results)},_updateLocation:function(){if(this.map){if("number"!==typeof this.latitude||isNaN(this.latitude))throw new TypeError("latitude must be a number");if("number"!==typeof this.longitude||
isNaN(this.longitude))throw new TypeError("longitude must be a number");this._setLocation({lat:this.latitude,lng:this.longitude})}}});D.GoogleMap.GoogleMapElements={};D.IronDropdown={};D.IronDropdown.IronDropdownScrollManager={};
(function(){var a={pageX:0,pageY:0},b=null,c=[];Polymer.IronDropdownScrollManager={get currentLockingElement(){return this._lockingElements[this._lockingElements.length-1]},elementIsScrollLocked:function(a){var b=this.currentLockingElement;if(void 0===b)return!1;if(this._hasCachedLockedElement(a))return!0;if(this._hasCachedUnlockedElement(a))return!1;(b=!!b&&b!==a&&!this._composedTreeContains(b,a))?this._lockedElementCache.push(a):this._unlockedElementCache.push(a);return b},pushScrollLock:function(a){0<=
...
this._lockedElementCache.indexOf(a)},_hasCachedUnlockedElement:function(a){return-1<this._unlockedElementCache.indexOf(a)},_composedTreeContains:function(a,b){var c,d;if(a.contains(b))return!0;a=Polymer.dom(a).querySelectorAll("content");for(c=0;c<a.length;++c){var e=Polymer.dom(a[c]).getDistributedNodes();for(d=0;d<e.length;++d)if(this._composedTreeContains(e[d],b))return!0}return!1},_scrollInteractionHandler:function(b){b.cancelable&&this._shouldPreventScrolling(b)&&b.preventDefault();b.targetTouches&&
(b=b.targetTouches[0],a.pageX=b.pageX,a.pageY=b.pageY)},_lockScrollInteractions:function(){this._boundScrollHandler=this._boundScrollHandler||this._scrollInteractionHandler.bind(this);document.addEventListener("wheel",this._boundScrollHandler,!0);document.addEventListener("mousewheel",this._boundScrollHandler,!0);document.addEventListener("DOMMouseScroll",this._boundScrollHandler,!0);document.addEventListener("touchstart",this._boundScrollHandler,!0);document.addEventListener("touchmove",this._boundScrollHandler,
!0)},_unlockScrollInteractions:function(){document.removeEventListener("wheel",this._boundScrollHandler,!0);document.removeEventListener("mousewheel",this._boundScrollHandler,!0);document.removeEventListener("DOMMouseScroll",this._boundScrollHandler,!0);document.removeEventListener("touchstart",this._boundScrollHandler,!0);document.removeEventListener("touchmove",this._boundScrollHandler,!0)},_shouldPreventScrolling:function(a){var d=Polymer.dom(a).rootTarget;"touchmove"!==a.type&&b!==d&&(b=d,c=this._getScrollableNodes(Polymer.dom(a).path));
if(!c.length)return!0;if("touchstart"===a.type)return!1;a=this._getScrollInfo(a);return!this._getScrollingNode(c,a.deltaX,a.deltaY)},_getScrollableNodes:function(a){for(var b=[],c=a.indexOf(this.currentLockingElement),d=0;d<=c;d++)if(a[d].nodeType===Node.ELEMENT_NODE){var h=a[d],k=h.style;"scroll"!==k.overflow&&"auto"!==k.overflow&&(k=window.getComputedStyle(h));"scroll"!==k.overflow&&"auto"!==k.overflow||b.push(h)}return b},_getScrollingNode:function(a,b,c){if(b||c)for(var d=Math.abs(c)>=Math.abs(b),
e=0;e<a.length;e++){var f=a[e],m;if(m=d?0>c?0<f.scrollTop:f.scrollTop<f.scrollHeight-f.clientHeight:0>b?0<f.scrollLeft:f.scrollLeft<f.scrollWidth-f.clientWidth)return f}},_getScrollInfo:function(b){var c={deltaX:b.deltaX,deltaY:b.deltaY};"deltaX"in b||("wheelDeltaX"in b?(c.deltaX=-b.wheelDeltaX,c.deltaY=-b.wheelDeltaY):"axis"in b?(c.deltaX=1===b.axis?b.detail:0,c.deltaY=2===b.axis?b.detail:0):b.targetTouches&&(b=b.targetTouches[0],c.deltaX=a.pageX-b.pageX,c.deltaY=a.pageY-b.pageY));return c}}})();D.IronFitBehavior={};D.IronFitBehavior.IronFitBehavior={};
...
this.fitInto.getBoundingClientRect().width},get _fitHeight(){var a;return a=this.fitInto===window?this.fitInto.innerHeight:this.fitInto.getBoundingClientRect().height},get _fitLeft(){var a;return a=this.fitInto===window?0:this.fitInto.getBoundingClientRect().left},get _fitTop(){var a;return a=this.fitInto===window?0:this.fitInto.getBoundingClientRect().top},get _defaultPositionTarget(){var a=Polymer.dom(this).parentNode;a&&a.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&(a=a.host);return a},get _localeHorizontalAlign(){if(this._isRTL){if("right"===
this.horizontalAlign)return"left";if("left"===this.horizontalAlign)return"right"}return this.horizontalAlign},attached:function(){"undefined"===typeof this._isRTL&&(this._isRTL="rtl"==window.getComputedStyle(this).direction);this.positionTarget=this.positionTarget||this._defaultPositionTarget;this.autoFitOnAttach&&("none"===window.getComputedStyle(this).display?setTimeout(function(){this.fit()}.bind(this)):(window.ShadyDOM&&ShadyDOM.flush(),this.fit()))},detached:function(){this.__deferredFit&&(clearTimeout(this.__deferredFit),
this.__deferredFit=null)},fit:function(){this.position();this.constrain();this.center()},_discoverInfo:function(){if(!this._fitInfo){var a=window.getComputedStyle(this),b=window.getComputedStyle(this.sizingTarget);this._fitInfo={inlineStyle:{top:this.style.top||"",left:this.style.left||"",position:this.style.position||""},sizerInlineStyle:{maxWidth:this.sizingTarget.style.maxWidth||"",maxHeight:this.sizingTarget.style.maxHeight||"",boxSizing:this.sizingTarget.style.boxSizing||""},positionedBy:{vertically:"auto"!==
a.top?"top":"auto"!==a.bottom?"bottom":null,horizontally:"auto"!==a.left?"left":"auto"!==a.right?"right":null},sizedBy:{height:"none"!==b.maxHeight,width:"none"!==b.maxWidth,minWidth:parseInt(b.minWidth,10)||0,minHeight:parseInt(b.minHeight,10)||0},margin:{top:parseInt(a.marginTop,10)||0,right:parseInt(a.marginRight,10)||0,bottom:parseInt(a.marginBottom,10)||0,left:parseInt(a.marginLeft,10)||0}}}},resetFit:function(){var a=this._fitInfo||{},b;for(b in a.sizerInlineStyle)this.sizingTarget.style[b]=
a.sizerInlineStyle[b];for(b in a.inlineStyle)this.style[b]=a.inlineStyle[b];this._fitInfo=null},refit:function(){var a=this.sizingTarget.scrollLeft,b=this.sizingTarget.scrollTop;this.resetFit();this.fit();this.sizingTarget.scrollLeft=a;this.sizingTarget.scrollTop=b},position:function(){if(this.horizontalAlign||this.verticalAlign){this._discoverInfo();this.style.position="fixed";this.sizingTarget.style.boxSizing="border-box";this.style.left="0px";this.style.top="0px";var a=this.getBoundingClientRect(),
b=this.__getNormalizedRect(this.positionTarget),c=this.__getNormalizedRect(this.fitInto),d=this._fitInfo.margin,e={width:a.width+d.left+d.right,height:a.height+d.top+d.bottom};e=this.__getPosition(this._localeHorizontalAlign,this.verticalAlign,e,b,c);b=e.left+d.left;e=e.top+d.top;var f=Math.min(c.right-d.right,b+a.width),l=Math.min(c.bottom-d.bottom,e+a.height);b=Math.max(c.left+d.left,Math.min(b,f-this._fitInfo.sizedBy.minWidth));e=Math.max(c.top+d.top,Math.min(e,l-this._fitInfo.sizedBy.minHeight));
this.sizingTarget.style.maxWidth=Math.max(f-b,this._fitInfo.sizedBy.minWidth)+"px";this.sizingTarget.style.maxHeight=Math.max(l-e,this._fitInfo.sizedBy.minHeight)+"px";this.style.left=b-a.left+"px";this.style.top=e-a.top+"px"}},constrain:function(){if(!this.horizontalAlign&&!this.verticalAlign){this._discoverInfo();var a=this._fitInfo;a.positionedBy.vertically||(this.style.position="fixed",this.style.top="0px");a.positionedBy.horizontally||(this.style.position="fixed",this.style.left="0px");this.sizingTarget.style.boxSizing=
"border-box";var b=this.getBoundingClientRect();a.sizedBy.height||this.__sizeDimension(b,a.positionedBy.vertically,"top","bottom","Height");a.sizedBy.width||this.__sizeDimension(b,a.positionedBy.horizontally,"left","right","Width")}},_sizeDimension:function(a,b,c,d,e){this.__sizeDimension(a,b,c,d,e)},__sizeDimension:function(a,b,c,d,e){var f=this._fitInfo,l=this.__getNormalizedRect(this.fitInto);l="Width"===e?l.width:l.height;a=(b=b===d)?l-a[d]:a[c];c=f.margin[b?c:d];d="offset"+e;d=this[d]-this.sizingTarget[d];
this.sizingTarget.style["max"+e]=l-c-a-d+"px"},center:function(){if(!this.horizontalAlign&&!this.verticalAlign){this._discoverInfo();var a=this._fitInfo.positionedBy;if(!a.vertically||!a.horizontally){this.style.position="fixed";a.vertically||(this.style.top="0px");a.horizontally||(this.style.left="0px");var b=this.getBoundingClientRect(),c=this.__getNormalizedRect(this.fitInto);if(!a.vertically){var d=c.top-b.top+(c.height-b.height)/2;this.style.top=d+"px"}a.horizontally||(a=c.left-b.left+(c.width-
b.width)/2,this.style.left=a+"px")}}},__getNormalizedRect:function(a){return a===document.documentElement||a===window?{top:0,left:0,width:window.innerWidth,height:window.innerHeight,right:window.innerWidth,bottom:window.innerHeight}:a.getBoundingClientRect()},__getCroppedArea:function(a,b,c){var d=Math.min(0,a.top)+Math.min(0,c.bottom-(a.top+b.height));a=Math.min(0,a.left)+Math.min(0,c.right-(a.left+b.width));return Math.abs(d)*b.width+Math.abs(a)*b.height},__getPosition:function(a,b,c,d,e){var f=
[{verticalAlign:"top",horizontalAlign:"left",top:d.top+this.verticalOffset,left:d.left+this.horizontalOffset},{verticalAlign:"top",horizontalAlign:"right",top:d.top+this.verticalOffset,left:d.right-c.width-this.horizontalOffset},{verticalAlign:"bottom",horizontalAlign:"left",top:d.bottom-c.height-this.verticalOffset,left:d.left+this.horizontalOffset},{verticalAlign:"bottom",horizontalAlign:"right",top:d.bottom-c.height-this.verticalOffset,left:d.right-c.width-this.horizontalOffset}];if(this.noOverlap){for(var l=
0,h=f.length;l<h;l++){var k={},m;for(m in f[l])k[m]=f[l][m];f.push(k)}f[0].top=f[1].top+=d.height;f[2].top=f[3].top-=d.height;f[4].left=f[6].left+=d.width;f[5].left=f[7].left-=d.width}b="auto"===b?null:b;a="auto"===a?null:a;for(l=0;l<f.length;l++){d=f[l];if(!this.dynamicAlign&&!this.noOverlap&&d.verticalAlign===b&&d.horizontalAlign===a){var r=d;break}h=(!b||d.verticalAlign===b)&&(!a||d.horizontalAlign===a);if(this.dynamicAlign||h){r=r||d;d.croppedArea=this.__getCroppedArea(d,c,e);k=d.croppedArea-
r.croppedArea;if(0>k||0===k&&h)r=d;if(0===r.croppedArea&&h)break}}return r}};D.IronOverlayBehavior={};D.IronOverlayBehavior.IronFocusablesHelper={};
(function(){var a=Element.prototype,b=a.matches||a.matchesSelector||a.mozMatchesSelector||a.msMatchesSelector||a.oMatchesSelector||a.webkitMatchesSelector;Polymer.IronFocusablesHelper={getTabbableNodes:function(a){var b=[];return(a=this._collectTabbableNodes(a,b))?this._sortByTabIndex(b):b},isFocusable:function(a){return b.call(a,"input, select, textarea, button, object")?b.call(a,":not([disabled])"):b.call(a,"a[href], area[href], iframe, [tabindex], [contentEditable]")},isTabbable:function(a){return this.isFocusable(a)&&
b.call(a,':not([tabindex="-1"])')&&this._isVisible(a)},_normalizedTabIndex:function(a){return this.isFocusable(a)?(a=a.getAttribute("tabindex")||0,Number(a)):-1},_collectTabbableNodes:function(a,b){if(a.nodeType!==Node.ELEMENT_NODE||!this._isVisible(a))return!1;var c=a,d=this._normalizedTabIndex(c);a=0<d;0<=d&&b.push(c);c="content"===c.localName||"slot"===c.localName?Polymer.dom(c).getDistributedNodes():Polymer.dom(c.root||c).children;for(d=0;d<c.length;d++)a=this._collectTabbableNodes(c[d],b)||a;
return a},_isVisible:function(a){var b=a.style;return"hidden"!==b.visibility&&"none"!==b.display?(b=window.getComputedStyle(a),"hidden"!==b.visibility&&"none"!==b.display):!1},_sortByTabIndex:function(a){var b=a.length;if(2>b)return a;var c=Math.ceil(b/2);b=this._sortByTabIndex(a.slice(0,c));a=this._sortByTabIndex(a.slice(c));return this._mergeSortByTabIndex(b,a)},_mergeSortByTabIndex:function(a,b){for(var c=[];0<a.length&&0<b.length;)this._hasLowerTabOrder(a[0],b[0])?c.push(b.shift()):c.push(a.shift());
return c.concat(a,b)},_hasLowerTabOrder:function(a,b){a=Math.max(a.tabIndex,0);b=Math.max(b.tabIndex,0);return 0===a||0===b?b>a:a>b}}})();D.IronOverlayBehavior.IronOverlayBackdrop={};
...
this._overlays.length-1,d=this._overlays[c];d&&this._shouldBeBehindOverlay(b,d)&&c--;if(!(a>=c)){d=Math.max(this.currentOverlayZ(),this._minimumZ);for(this._getZ(b)<=d&&this._applyOverlayZ(b,d);a<c;)this._overlays[a]=this._overlays[a+1],a++;this._overlays[c]=b}}},addOverlay:function(a){var b=this._overlays.indexOf(a);if(0<=b)this._bringOverlayAtIndexToFront(b);else{b=this._overlays.length;var c=this._overlays[b-1],d=Math.max(this._getZ(c),this._minimumZ),e=this._getZ(a);c&&this._shouldBeBehindOverlay(a,
c)&&(this._applyOverlayZ(c,d),b--,c=this._overlays[b-1],d=Math.max(this._getZ(c),this._minimumZ));e<=d&&this._applyOverlayZ(a,d);this._overlays.splice(b,0,a)}this.trackBackdrop()},removeOverlay:function(a){a=this._overlays.indexOf(a);-1!==a&&(this._overlays.splice(a,1),this.trackBackdrop())},currentOverlay:function(){var a=this._overlays.length-1;return this._overlays[a]},currentOverlayZ:function(){return this._getZ(this.currentOverlay())},trackBackdrop:function(){var a=this._overlayWithBackdrop();
if(a||this._backdropElement)this.backdropElement.style.zIndex=this._getZ(a)-1,this.backdropElement.opened=!!a,this.backdropElement.prepare()},_overlayWithBackdrop:function(){for(var a=0;a<this._overlays.length;a++)if(this._overlays[a].withBackdrop)return this._overlays[a]},_getZ:function(a){var b=this._minimumZ;a&&(a=Number(a.style.zIndex||window.getComputedStyle(a).zIndex),a===a&&(b=a));return b},_setZ:function(a,b){a.style.zIndex=b},_applyOverlayZ:function(a,b){this._setZ(a,b+2)},_overlayInPath:function(a){a=
a||[];for(var b=0;b<a.length;b++)if(a[b]._manager===this)return a[b]},_onCaptureClick:function(a){var b=this._overlays.length-1;if(-1!==b)for(var c=Polymer.dom(a).path,d;(d=this._overlays[b])&&this._overlayInPath(c)!==d;)if(d._onCaptureClick(a),d.allowClickThrough)b--;else break},_onCaptureFocus:function(a){var b=this.currentOverlay();b&&b._onCaptureFocus(a)},_onCaptureKeyDown:function(a){var b=this.currentOverlay();b&&(Polymer.IronA11yKeysBehavior.keyboardEventMatchesKeys(a,"esc")?b._onCaptureEsc(a):
Polymer.IronA11yKeysBehavior.keyboardEventMatchesKeys(a,"tab")&&b._onCaptureTab(a))},_shouldBeBehindOverlay:function(a,b){return!a.alwaysOnTop&&b.alwaysOnTop}};Polymer.IronOverlayManager=new Polymer.IronOverlayManagerClass;D.IronOverlayBehavior.IronScrollManager={};
(function(){var a={pageX:0,pageY:0},b=null,c=[],d=["wheel","mousewheel","DOMMouseScroll","touchstart","touchmove"];Polymer.IronScrollManager={get currentLockingElement(){return this._lockingElements[this._lockingElements.length-1]},elementIsScrollLocked:function(a){var b=this.currentLockingElement;if(void 0===b)return!1;if(this._hasCachedLockedElement(a))return!0;if(this._hasCachedUnlockedElement(a))return!1;(b=!!b&&b!==a&&!this._composedTreeContains(b,a))?this._lockedElementCache.push(a):this._unlockedElementCache.push(a);
return b},pushScrollLock:function(a){0<=this._lockingElements.indexOf(a)||(0===this._lockingElements.length&&this._lockScrollInteractions(),this._lockingElements.push(a),this._lockedElementCache=[],this._unlockedElementCache=[])},removeScrollLock:function(a){a=this._lockingElements.indexOf(a);-1!==a&&(this._lockingElements.splice(a,1),this._lockedElementCache=[],this._unlockedElementCache=[],0===this._lockingElements.length&&this._unlockScrollInteractions())},_lockingElements:[],_lockedElementCache:null,
_unlockedElementCache:null,_hasCachedLockedElement:function(a){return-1<this._lockedElementCache.indexOf(a)},_hasCachedUnlockedElement:function(a){return-1<this._unlockedElementCache.indexOf(a)},_composedTreeContains:function(a,b){var c,d;if(a.contains(b))return!0;a=Polymer.dom(a).querySelectorAll("content,slot");for(c=0;c<a.length;++c){var e=Polymer.dom(a[c]).getDistributedNodes();for(d=0;d<e.length;++d)if(e[d].nodeType===Node.ELEMENT_NODE&&this._composedTreeContains(e[d],b))return!0}return!1},_scrollInteractionHandler:function(b){b.cancelable&&
this._shouldPreventScrolling(b)&&b.preventDefault();b.targetTouches&&(b=b.targetTouches[0],a.pageX=b.pageX,a.pageY=b.pageY)},_lockScrollInteractions:function(){this._boundScrollHandler=this._boundScrollHandler||this._scrollInteractionHandler.bind(this);for(var a=0,b=d.length;a<b;a++)document.addEventListener(d[a],this._boundScrollHandler,{capture:!0,passive:!1})},_unlockScrollInteractions:function(){for(var a=0,b=d.length;a<b;a++)document.removeEventListener(d[a],this._boundScrollHandler,{capture:!0,
passive:!1})},_shouldPreventScrolling:function(a){var d=Polymer.dom(a).rootTarget;"touchmove"!==a.type&&b!==d&&(b=d,c=this._getScrollableNodes(Polymer.dom(a).path));if(!c.length)return!0;if("touchstart"===a.type)return!1;a=this._getScrollInfo(a);return!this._getScrollingNode(c,a.deltaX,a.deltaY)},_getScrollableNodes:function(a){for(var b=[],c=a.indexOf(this.currentLockingElement),d=0;d<=c;d++)if(a[d].nodeType===Node.ELEMENT_NODE){var e=a[d],m=e.style;"scroll"!==m.overflow&&"auto"!==m.overflow&&(m=
window.getComputedStyle(e));"scroll"!==m.overflow&&"auto"!==m.overflow||b.push(e)}return b},_getScrollingNode:function(a,b,c){if(b||c)for(var d=Math.abs(c)>=Math.abs(b),e=0;e<a.length;e++){var f=a[e],l;if(l=d?0>c?0<f.scrollTop:f.scrollTop<f.scrollHeight-f.clientHeight:0>b?0<f.scrollLeft:f.scrollLeft<f.scrollWidth-f.clientWidth)return f}},_getScrollInfo:function(b){var c={deltaX:b.deltaX,deltaY:b.deltaY};"deltaX"in b||("wheelDeltaX"in b&&"wheelDeltaY"in b?(c.deltaX=-b.wheelDeltaX,c.deltaY=-b.wheelDeltaY):
"wheelDelta"in b?(c.deltaX=0,c.deltaY=-b.wheelDelta):"axis"in b?(c.deltaX=1===b.axis?b.detail:0,c.deltaY=2===b.axis?b.detail:0):b.targetTouches&&(b=b.targetTouches[0],c.deltaX=a.pageX-b.pageX,c.deltaY=a.pageY-b.pageY));return c}}})();D.IronOverlayBehavior.IronOverlayBehavior={};
...
this.__isAnimating=!1;this.__firstFocusableNode=this.__lastFocusableNode=null;this.__rafs={};this.__scrollTop=this.__scrollLeft=this.__restoreFocusNode=null;this.__onCaptureScroll=this.__onCaptureScroll.bind(this);this._ensureSetup()},attached:function(){this.opened&&this._openedChanged(this.opened);this._observer=Polymer.dom(this).observeNodes(this._onNodesChange)},detached:function(){Polymer.dom(this).unobserveNodes(this._observer);this._observer=null;for(var a in this.__rafs)null!==this.__rafs[a]&&
cancelAnimationFrame(this.__rafs[a]);this.__rafs={};this._manager.removeOverlay(this);this.__isAnimating&&(this.opened?this._finishRenderOpened():(this._applyFocus(),this._finishRenderClosed()))},toggle:function(){this._setCanceled(!1);this.opened=!this.opened},open:function(){this._setCanceled(!1);this.opened=!0},close:function(){this._setCanceled(!1);this.opened=!1},cancel:function(a){a=this.fire("iron-overlay-canceled",a,{cancelable:!0});a.defaultPrevented||(this._setCanceled(!0),this.opened=!1)},
invalidateTabbables:function(){this.__firstFocusableNode=this.__lastFocusableNode=null},_ensureSetup:function(){this._overlaySetup||(this._overlaySetup=!0,this.style.outline="none",this.style.display="none")},_openedChanged:function(a){a?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true");this.isAttached&&(this.__isAnimating=!0,this.__deraf("__openedChanged",this.__openedChanged))},_canceledChanged:function(){this.closingReason=this.closingReason||{};this.closingReason.canceled=
...
this.focusTarget||this.containedElement;a&&this.opened&&!this.noAutoFocus?a.focus():Polymer.IronOverlayBehaviorImpl._applyFocus.apply(this,arguments)}});D.IronFlexLayout.IronFlexLayoutClasses={};Polymer({is:"saft-text-item",properties:{item:Object},entityClicked_:function(){this.fire("entity-click",{data:this.item.data})}});
Polymer({is:"saft-text",properties:{text:String,ranges:{type:Array,value:function(){return[]}},renderStream_:{type:Array,value:function(){return[]}}},observers:["inputChanged_(text, ranges.*)"],checkNonOverlappingReferences:function(a){for(var b=0;b<a.length-1;b++){var c=a[b],d=a[b+1];c=c.end;d=d.start;if(c>=d)return!1}return!0},getRenderStream_:function(a,b){b=(b||[]).slice(0);b=b.sort(function(a,b){return a.start-b.start});this.checkNonOverlappingReferences(b)||console.error("Overlapping phrases in input.");
for(var c=[],d=0,e=0;e<b.length;e++){var f=b[e];d<f.start&&c.push({text:a.substring(d,f.start),data:null});f.start<f.end&&c.push({text:a.substring(f.start,f.end),color:f.color,index:f.index,data:f.data});d=f.end}d<a.length&&c.push({text:a.substring(d),data:null});return c},inputChanged_:function(a,b){this.renderStream_=this.getRenderStream_(a,b.base)}});
Polymer({is:"entity-box",properties:{index:Number,kindColor:String,name:String,type:String,metadata:Object,salience:Number,sentiment:Object,hideSalience:{type:Boolean,value:!1},hideWikipediaUrl:{type:Boolean,value:!1},hideSentiment:{type:Boolean,value:!1},boxHeight:{type:Number,value:125}},readableIndex_:function(a){return a+1},roundFloat_:function(a){return a.toFixed(2)},formatTypeText_:function(a){return a.replace(/_/g," ")},shouldShow_:function(a,b){return!0!==b&&void 0!==a&&null!==a&&""!=a}});
Polymer({is:"saft-entity-view",properties:{text:String,entities:{type:Array},entityRanges_:{type:Array,computed:"computeEntityRanges_(entities.*)"},hideSalience:{type:Boolean,value:!1},hideWikipediaUrl:{type:Boolean,value:!1},hideSentiment:{type:Boolean,value:!1},boxHeight:{type:Number,value:125}},computeEntityRanges_:function(a){var b=this;a=a.base;var c=[];a.forEach(function(a,e){a.mentions.forEach(function(d){var f=d.text,h=f.beginOffset;0>h?console.error('Unexpected negative offset for entity mention. Requests should have the "encodingType" parameter set to "UTF16" to provide the correct offsets.'):
(f=h+f.content.length,c.push({start:h,end:f,data:d,index:e+1,color:b.getEntityTypeColor_(a.type)}))})});return c},getEntityTypeColor_:function(a){switch(a){case "EVENT":return"#b29838";case "PERSON":return"#db4437";case "ORGANIZATION":return"#0000ff";case "CONSUMER_GOOD":return"#800080";case "LOCATION":return"#008000";case "WORK_OF_ART":return"#ff8c00";case "OTHER":return"#800000";case "UNKNOWN":return"#73909c"}}});Polymer({is:"vs-app",CROP_HINT_RATIOS:[.8,1,1.2],ERROR_MESSAGE:"There was an error connecting to service. Please, try again!",VALID_IMAGE_MESSAGE:"Please upload a valid image type.",MAX_SIZE_MESSAGE:"Maximum size of file upload is ",FEATURES:"TYPE_UNSPECIFIED LANDMARK_DETECTION FACE_DETECTION LOGO_DETECTION LABEL_DETECTION DOCUMENT_TEXT_DETECTION SAFE_SEARCH_DETECTION IMAGE_PROPERTIES CROP_HINTS WEB_DETECTION".split(" "),UNSUPPORTED_DOC_LANGUAGES:"ja zh el he iw ko th".split(" "),IMAGE_TYPES:"jpeg|jpg|png|gif|bmp|tiff",
MAX_RESULTS:50,MAX_UPLOAD_SIZE_MB:4,properties:{serviceURL:{type:String,value:"https://vision.googleapis.com/v1/images:annotate"},proxyURL:{type:String,value:"https://cxl-services.appspot.com/proxy"},currentFile:{type:Object,notify:!0},maxImageWidth:{type:Number,value:550},maxImageHeight:{type:Number,value:550},resultData:{type:Object,value:{}},scrollableTabsWidth:{type:Number,value:600},showLoading:{type:Boolean,value:!1,notify:!0},showPreview:{type:Boolean,value:!1,notify:!0},showResults:{type:Boolean,
value:!1,notify:!0},titleText:{type:String,value:"Try the API"},verified:{type:Boolean,value:!1}},ready:function(){var a=this;this._supportsFileUpload()?(this.$.input.addEventListener("change",function(b){b.target.value&&a.readFile(b.target.files)}),"drag dragstart dragend dragover dragenter dragleave drop".split(" ").forEach(function(b){a.$.dropzone.addEventListener(b,function(a){a.preventDefault();a.stopPropagation()})}),["dragover","dragenter"].forEach(function(b){a.$.dropzone.addEventListener(b,
function(){a.$.dropzone.classList.add("hover")})}),["dragleave","dragend","drop"].forEach(function(b){a.$.dropzone.addEventListener(b,function(){a.$.dropzone.classList.remove("hover")})}),this.$.dropzone.addEventListener("drop",function(b){b=b.dataTransfer.files;0<b.length&&a.readFile(b[0])}),this.$.next.addEventListener("tap",function(){return a.reset()}),this.$.exit.addEventListener("tap",function(){return a.reset()}),window.addEventListener("resize",function(b){return a.handleResize(b)})):this.remove()},
readFile:function(a){var b=this;this.showLoading=!0;void 0!==a.length&&(a=a[0]);if(null!==a&&this._validateFile(a)){this.currentFile=a;var c=new FileReader;c.onload=function(a){b.$.image.source=a.target.result};c.onloadend=function(){b.$.image.source=b.$.image.resizeImageOnLoad(a);b.sendImage()};c.readAsDataURL(a)}else this.reset()},isFeatureSupported:function(a){switch(a){case "DOCUMENT_TEXT_DETECTION":a=window.navigator.languages;a=n.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if(b=b.value,
-1<this.UNSUPPORTED_DOC_LANGUAGES.indexOf(b))return!1;return!0;default:return!0}},sendImage:function(){var a=this;this.showLoading=this.showPreview=!0;var b=this.$.image.source;this.$.image.addEventListener("vs-image-load",function(){a.handleResultSizes()});var c=new RegExp("^data:image\\/("+this.IMAGE_TYPES+");base64,");b=b.replace(c,"");c=[];for(var d=n.makeIterator(this.FEATURES),e=d.next();!e.done;e=d.next())e=e.value,this.isFeatureSupported(e)&&c.push({type:e,maxResults:this.MAX_RESULTS});b=
JSON.stringify({requests:[{image:{content:b},features:c,imageContext:{cropHintsParams:{aspectRatios:this.CROP_HINT_RATIOS}}}]});c=this.proxyURL+"?url="+encodeURIComponent(this.serviceURL);var f=new XMLHttpRequest;f.onload=function(b){a.showLoading=!1;200<=f.status&&400>f.status?(b=JSON.parse(f.responseText),a.handleResults(b)):a.handleError(b)};f.onerror=function(){return a.handleError};f.open("POST",c,!0);f.send(b)},handleResults:function(a){var b=this;"string"===typeof a&&(a=JSON.parse(a));this.resultData=
a=a.responses[0];this.cachedTabs||(this.cachedTabs=this.$.tabs.querySelectorAll("paper-tab[id]"));for(var c=!1,d=0;d<this.cachedTabs.length;d++){var e=this.cachedTabs[d],f=e.id,l=this.$.results.children[d],h=a[f];this.$.json.data=a;if("imagePropertiesAnnotation"===f&&"cropHintsAnnotation"in a){h.cropHints=a.cropHintsAnnotation.cropHints;var k=this.$.image;h.cropHints.forEach(function(a,c){a.ratio=b.CROP_HINT_RATIOS[c];var d=a.boundingPoly.vertices;c=d[0].x||0;var e=d[0].y||0,f=d[2].x||0;d=d[2].y||
0;a.imageURI=k.getCroppedDataURI(c,e,f-c,d-e)})}h?(e.removeAttribute("hidden"),l.removeAttribute("hidden"),c||(this.selected=d,c=!0,this.handlePolydata(f,h)),l.data=h):(e.setAttribute("hidden",!0),l.setAttribute("hidden",!0),l.data=null);this.$.wrapper.classList.remove("center-all");this.$.wrapper.classList.add("center-horizontal");this.showResults=!0}this.$.tabs.notifyResize();this.handleResultSizes()},handleError:function(a){this.showLoading=!1;this.reset();window.console.error(a);window.alert(this.ERROR_MESSAGE)},
handleResize:function(){var a=this.clientWidth;if(a){var b=this.$.tabs;b&&(b.scrollable=a<this.scrollableTabsWidth)}},handleResultSizes:function(){var a=this.$.results.querySelectorAll("vs-card > paper-card");a=n.makeIterator(a);for(var b=a.next();!b.done;b=a.next())b=b.value,b.style.maxHeight=this.$.image.height+"px"},handlePolydata:function(a,b){var c=this.$.image;c.clear();if("faceAnnotations"===a)b.forEach(function(a,d){c.drawPoly(a.boundingPoly.vertices);c.drawPoly(a.fdBoundingPoly.vertices);
a.landmarks.forEach(function(a){c.drawPoint(a.position.x,a.position.y)});1<b.length&&(a=a.boundingPoly.vertices[0],c.drawText("Face "+(d+1),a.x,a.y))});else if("landmarkAnnotations"===a)b.forEach(function(a){c.drawPoly(a.boundingPoly.vertices);var b=a.boundingPoly.vertices[0];c.drawText(a.description,b.x,b.y)});else if("textAnnotations"===a)b.forEach(function(a,b){0<b&&c.drawPoly(a.boundingPoly.vertices)});else if("fullTextAnnotation"===a){a=n.makeIterator(b.pages);for(var d=a.next();!d.done;d=a.next()){d=
d.value;d=n.makeIterator(d.blocks);for(var e=d.next();!e.done;e=d.next()){var f=e.value;e=c.color;c.color="#2CBBFF";c.drawPoly(this._expandBox(f.boundingBox.vertices,6*c.scale));f=n.makeIterator(f.paragraphs);for(var l=f.next();!l.done;l=f.next()){l=l.value;c.color=e;c.drawPoly(this._expandBox(l.boundingBox.vertices,3*c.scale));l=n.makeIterator(l.words);for(var h=l.next();!h.done;h=l.next()){var k=h.value;c.color="#FFAA0A";h=k.boundingBox.vertices[2];k=k.boundingBox.vertices[3];c.drawLine(h.x,h.y,
k.x,k.y);c.color=e}}}}}else"logoAnnotations"===a&&b.forEach(function(a){c.drawPoly(a.boundingPoly.vertices);var b=a.boundingPoly.vertices[0];c.drawText(a.description,b.x,b.y)})},onActivate:function(a,b){a=b.item.id;this.resultData&&this.handlePolydata(a,this.resultData[a])},reset:function(){this.currentFile=null;this.resultData={};this.showResults=this.showPreview=this.showLoading=!1;this.$.image&&(this.$.image.source="");this.$.imageName&&(this.$.imageName.innerHTML="");this.$.input&&(this.$.input.value=
"");this.$.wrapper.classList.add("center-all");this.$.wrapper.classList.remove("center-horizontal");for(var a=0;a<this.$.results.children.length;a++)this.$.results.children[a].data=null},_expandBox:function(a,b){var c=[{},{},{},{}];c[0].x=a[0].x-b;c[0].y=a[0].y-b;c[1].x=a[1].x+b;c[1].y=a[1].y-b;c[2].x=a[2].x+b;c[2].y=a[2].y+b;c[3].x=a[3].x-b;c[3].y=a[3].y+b;return c},_supportsFileUpload:function(){var a=document.createElement("div");return("draggable"in a||"ondragstart"in a&&"ondrop"in a)&&"FileReader"in
window},_validateFile:function(a){var b=new RegExp("\\/"+this.IMAGE_TYPES+"^");return b.test(a.type)?!0:(window.alert(this.VALID_IMAGE_MESSAGE),!1)}});Polymer({is:"vs-card",properties:{center:{type:Boolean,value:!1,notify:!0}},ready:function(){var a=this;this.$.card.addEventListener("mousewheel",function(b){a.$.card.scrollTop-=b.wheelDeltaY;b.stopPropagation();b.stopPropagation();return b.returnValue=!1})}});Polymer({is:"vs-likeliness",SCORES:{UNKNOWN:{value:0,color:"#999",text:"Unknown"},VERY_UNLIKELY:{value:1,color:"#A5D6A7",text:"Very Unlikely"},UNLIKELY:{value:2,color:"#81C784",text:"Unlikely"},POSSIBLE:{value:3,color:"#66BB6A",text:"Possible"},LIKELY:{value:4,color:"#4CAF50",text:"Likely"},VERY_LIKELY:{value:5,color:"#43A047",text:"Very Likely"}},properties:{value:{type:String,observer:"_render"},label:{type:String,notify:!0},width:{type:Number,value:15},height:{type:Number,value:15}},_render:function(a){var b=
0,c="";if(a){var d=this.SCORES[a];c="repeating-linear-gradient(to right, "+d.color+", "+d.color+" "+this.width+"px, #fff "+this.width+"px, #fff "+2*this.width+"px)";b=d.value*this.width*2}a=this.$.bar;a.style.width=b+"px";a.style.height=this.height+"px";a.style.background=c;this.$.text.textContent=d.text}});Polymer({is:"vs-loading"});Polymer({is:"vs-document",properties:{data:{type:Object,notify:!0}},toggleSection_:function(a){var b=a.currentTarget.parentElement,c=a.currentTarget.children[0];b.classList.contains("collapsed")?(b.classList.remove("collapsed"),setTimeout(function(){return c.innerText="+"},200)):(b.classList.add("collapsed"),setTimeout(function(){return c.innerText="-"},200))},increment_:function(a){return a+1},getLanguage_:function(a){var b=[];if(a.property){a=n.makeIterator(a.property.detectedLanguages);for(var c=
a.next();!c.done;c=a.next())c=c.value,b.push(c.languageCode.toUpperCase())}return b.join(", ")}});Polymer({is:"vs-faces",TYPES:{joyLikelihood:"Joy",sorrowLikelihood:"Sorrow",angerLikelihood:"Anger",surpriseLikelihood:"Surprise",underExposedLikelihood:"Exposed",blurredLikelihood:"Blurred",headwearLikelihood:"Headwear"},properties:{data:{type:Object,notify:!0,observer:"_onChange"}},_onChange:function(a){if(a&&a.length)for(var b=0;b<a.length;b++){var c=a[b],d=[],e;for(e in this.TYPES){var f=c[e];d.push({type:e,value:f,friendlyType:this.TYPES[e]})}c.types=d;c.detectionConfidence=Math.round(100*c.detectionConfidence);
c.tiltAngle=Math.round(c.tiltAngle);c.rollAngle=Math.round(c.rollAngle);c.panAngle=Math.round(c.panAngle);c.showHeader=1<a.length;c.num=b+1}}});Polymer({is:"vs-image",properties:{source:{type:String,notify:!0,observer:"_onSourceChange"},width:{type:Number},height:{type:Number},maxWidth:{type:Number,value:550},maxHeight:{type:Number,value:650},color:{type:String,value:"#76FF03"}},_onSourceChange:function(a){a||(this.clear(),this.height=this.width=this.ctx=null,this.$.image.style.width=null,this.$.image.style.height=null,this.$.canvas.style.width=null,this.$.canvas.style.height=null)},_onImageLoad:function(){this.fire("vs-image-load")},resizeImageOnLoad:function(a){var b=
this.$.canvas,c=this.$.image,d=c.width,e=c.height;this.maxWidth&&d>=e&&d>this.maxWidth&&(d=this.maxWidth/d,e*=d,d=this.maxWidth);this.maxHeight&&e>d&&e>this.maxHeight&&(e=this.maxHeight/e,d*=e,e=this.maxHeight);b.width=d;b.height=e;c.style.width=d+"px";c.style.height=e+"px";this.width=d;this.height=e;this.scale=this.width/c.naturalWidth;this.ctx=b.getContext("2d");a=(a.size/1048576).toFixed(2);4<a&&(this.ctx.drawImage(c,0,0,d,e),c.src=b.toDataURL("image/png"),this.scale=c.width/c.naturalWidth);return c.src},
drawRect:function(a,b,c){this._draw(function(d,e){a*=e;b*=e;c=(c+a)*e;d.rect(a,b,c,c)})},drawCircle:function(a,b,c){this._draw(function(d,e){d.beginPath();d.arc(a*e,b*e,c,0,2*Math.PI,!0);d.closePath();d.fill()})},drawPoint:function(a,b){this.drawCircle(a,b,2)},drawText:function(a,b,c,d,e,f){"number"!==typeof d&&(d=5);"number"!==typeof e&&(e=20);this._draw(function(l,h){l.font=f||"12px Arial";l.fillText(a,b*h+d,c*h+e)})},drawLine:function(a,b,c,d){a=a||0;b=b||0;c=c||0;d=d||0;this._draw(function(e,
f){e.beginPath();a*=f;b*=f;c*=f;d*=f;e.moveTo(a,b);e.lineTo(c,d);e.moveTo(a-1,b-1);e.lineTo(c-1,d-1)})},drawPoly:function(a){var b=this,c;a.forEach(function(a){c&&b.drawLine(c.x,c.y,a.x,a.y);c=a});this.drawLine(c.x,c.y,a[0].x,a[0].y)},clear:function(){var a=this.$.canvas;this.ctx.clearRect(0,0,a.width,a.height)},_draw:function(a){var b=this.ctx;b&&(b.strokeStyle=this.color,b.fillStyle=this.color,a(b,this.scale),b.stroke())},getCroppedDataURI:function(a,b,c,d){a*=this.scale;b*=this.scale;c*=this.scale;
d*=this.scale;var e=this.$.image,f=document.createElement("canvas");f.width=e.width;f.height=e.height;f=f.getContext("2d");f.drawImage(e,0,0,this.width,this.height);a=f.getImageData(a,b,c,d);b=document.createElement("canvas");b.width=c;b.height=d;e=b.getContext("2d");e.rect(0,0,c,d);e.fillStyle="white";e.fill();e.putImageData(a,0,0);return b.toDataURL("image/png")}});Polymer({is:"vs-json",properties:{data:{type:Object,notify:!0,observer:"_displayData"}},onScroll:function(a){this.$.wrapper.scrollTop-=a.wheelDeltaY;a.stopPropagation();return a.returnValue=!1},_displayData:function(a){"string"!==typeof a&&(a=JSON.stringify(a,null,2));a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");var b=this.localName;a=a.replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g,function(a){var c="number";
/^"/.test(a)?c=/:$/.test(a)?"key":"string":/true|false/.test(a)?c="boolean":/null/.test(a)&&(c="null");var e=document.createElement("span");e.className=c+" "+b;e.textContent=a;return e.outerHTML});this.$.display.innerHTML=a}});Polymer({is:"vs-labels",properties:{data:{type:Array,notify:!0,observer:"_onChange"}},_onChange:function(a){var b=this;a&&a.length&&a.forEach(function(a){a.description=b._toTitleCase(a.description);a.score=Math.round(100*a.score)})},_toTitleCase:function(a){return a.replace(/\w\S*/g,function(a){return a.charAt(0).toUpperCase()+a.substr(1).toLowerCase()})}});Polymer({is:"vs-landmarks",properties:{data:{type:Array,notify:!0,observer:"_onChange"},mapsApiKey:{type:String,value:"AIzaSyAIGTYIQR724YS4UPwzTrP1wUQ80qoZXmQ"}},_onChange:function(a){a&&a.length&&a.forEach(function(a){a.score=Math.round(100*a.score);a.lat=a.locations[0].latLng.latitude;a.long=a.locations[0].latLng.longitude;a.latText=parseFloat(a.lat).toFixed(6);a.longText=parseFloat(a.long).toFixed(6)})}});Polymer({is:"vs-logos",properties:{data:{type:Array,notify:!0,observer:"_onChange"}},_onChange:function(a){a&&a.length&&a.forEach(function(a){a.score=Math.round(100*a.score)})}});Polymer({is:"vs-properties",properties:{data:Object,colors:{type:Array,computed:"onChange_(data)"},cropHints:Array,current:Object},onChange_:function(a){var b=this;if(a){colors=a.dominantColors.colors;var c=0;colors.forEach(function(a){c+=a.score});colors.forEach(function(a){a.percent=a.score/c*100;a.percentRounded=Math.round(a.percent);a.rgb=a.color.red+", "+a.color.green+", "+a.color.blue;a.hex=b.convertRGB_(a.color.red,a.color.green,a.color.blue)});a.colors=colors;this.current=colors[0];this.cropHints=
a.cropHints;return colors}},onColorHover_:function(a){a=a.target;var b=Array.prototype.slice.call(a.parentElement.children);a=b.indexOf(a);this.current=this.colors[a]},convertRGB_:function(a,b,c){a=a<<16|b<<8|c;a=a.toString(16).toUpperCase();return a=Array(7-a.length).join("0")+a}});Polymer({is:"vs-safe",properties:{data:{type:Object},items:{type:Array,computed:"_onChange(data)"},helpMessage:{type:String,value:"Likeliness values are Unknown, Very Unlikely, Unlikely, Possible, Likely, and Very Likely"}},_onChange:function(a){if(a){var b=[],c;for(c in a){var d={name:this._capitalize(c),score:a[c]};b.push(d)}return b}},_capitalize:function(a){return a.charAt(0).toUpperCase()+a.slice(1)}});Polymer({is:"vs-web",properties:{data:{type:Array,notify:!0,observer:"onChange_"}},onChange_:function(a){a&&(this.processItems_(a.webEntities),this.processItems_(a.pagesWithMatchingImages),this.processItems_(a.fullMatchingImages),this.processItems_(a.partialMatchingImages))},processItems_:function(a){if(a&&a.length){a=n.makeIterator(a);for(var b=a.next();!b.done;b=a.next())b=b.value,b.description&&(b.description=this.abbreviateDescription_(b.description)),b.url&&(b.urlDisplay=this.abbreviateURL_(b.url)),
b.score&&(b.score=parseFloat(b.score.toFixed(5)))}},abbreviateDescription_:function(a){32<a.length&&(a=a.substring(0,32)+"...");return a},abbreviateURL_:function(a){var b=document.createElement("a");b.href=a;a=b.hostname;25<a.length&&(a=a.slice(-25));return a+"/..."}});
