...
Polymer({
    ...
    properties: {
        mapsUrl: {
            type: String,
            value: "https://maps.googleapis.com/maps/api/js??key=AIzaSyBOspDW8tix5pbR-b5muXP3XHCBTJYuV-A&callback=%%callback%%"
        },
        apiKey: {
            type: String,
            value: ""
...
Polymer({
    ...
    properties: {
        ...
        mapsApiKey: {
            type: String,
            value: "AIzaSyAIGTYIQR724YS4UPwzTrP1wUQ80qoZXmQ"
        }
    },
    _onChange: function(a) {
        a && a.length && a.forEach(function(a) {
